...
public class MysteriumPatchesFixesMagicka {
    ...
    private static MethodHandle createIsDrawingGet() {
        ...
        } catch (RuntimeException e) {} catch (NoClassDefFoundError e) {} catch (Exception e) {}
        return null;
    }
    ...
    private static MethodHandle createIsDrawingGetDelegate() {
        try {
            ...
            LogHelper.error(
                "Did not find tesselator isDrawing field! Only report this error if you're seeing it on a client!");
            return null;
        }
    }
    ...
    public static boolean startDrawing(Tessellator tsl, int p_78371_1_) {
        ...
        try {
            ...
            throw new RuntimeException(
                "Could not invoke isDrawing field! Only report this error if you're seeing it on a client!",
                e);
        }
        if (isDrawing) {
            return true;
