...
public class CustomItemRenderer implements IItemRenderer {
    ...
    private static final ResourceLocation sickleLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/plant_guardian.png"));
    private static final ResourceLocation arcaneBookLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/arcane_guardian.png"));
    private static final ResourceLocation winterArmLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/ice_guardian.png"));
    private static final ResourceLocation airLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/air_guardian.png"));
    private static final ResourceLocation waterLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/water_guardian.png"));
    private static final ResourceLocation fireLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/fire_guardian.png"));
    private static final ResourceLocation earthLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/earth_guardian.png"));
    private static final ResourceLocation broomLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("broom.png"));
    private static final ResourceLocation candleLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getCustomBlockTexturePath("candle.png"));
    private static final ResourceLocation casterLocation = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getCustomBlockTexturePath("blockCaster.png"));
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (item.getItem() == ItemsCommonProxy.wardingCandle
    ...
    private void renderCandleFlame(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (item.hasTagCompound()) {
            GL11.glColor3f(
                item.stackTagCompound.getFloat("flame_red"),
