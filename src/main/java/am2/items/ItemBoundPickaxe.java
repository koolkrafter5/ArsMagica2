...
public class ItemBoundPickaxe extends ItemPickaxe implements IBoundItem {
    ...
    public boolean onBlockDestroyed(ItemStack stack, World world, Block block, int x, int y, int z,
        ...
        if (!living.isSneaking() && stack.hasTagCompound()
            && this.getDigSpeed(stack, block, world.getBlockMetadata(x, y, z)) == this.efficiencyOnProperMaterial) {
            ...
            SpellHelper.instance.applyStackStage(
                ...
                y,
                z,
                stack.stackTagCompound.getInteger("block_break_face"),
                world,
                true,
                true,
                0);
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        ...
        if (mop != null && stack.hasTagCompound()) {
            ...
            if (mop.typeOfHit == MovingObjectType.BLOCK) SpellHelper.instance.applyStackStage(
                castStack,
                player,
                null,
                mop.hitVec.xCoord,
