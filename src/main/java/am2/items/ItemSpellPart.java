...
public class ItemSpellPart extends ArsMagicaItem {
    ...
    public void registerIcons(IIconRegister IIconRegister) {
        ...
        for (Integer i : parts) {
            ...
            String subfolder = "";
            if (entry instanceof ISpellShape) subfolder = "shapes";
            else if (entry instanceof ISpellComponent) subfolder = "components";
            else if (entry instanceof ISpellModifier) subfolder = "modifiers";
            else subfolder = "skills";

            String skillName = SkillManager.instance.getSkillName(entry);
            IIcon IIcon = ResourceManager
                .RegisterTexture(String.format("spells/%s/%s.png", subfolder, skillName), IIconRegister);
    ...
    public IIcon getIconFromDamage(int par1) {
        return SpellIconManager.instance
            .getIcon(SkillManager.instance.getSkillName(SkillManager.instance.getSkill(par1)));
    }
}
