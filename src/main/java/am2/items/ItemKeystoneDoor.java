...
public class ItemKeystoneDoor extends Item {
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4,
        ...
        if (par7 != 1) {
            ...
            ++par5;
            Block block;
            if (par1ItemStack.getItemDamage() == KEYSTONE_DOOR) block = BlocksCommonProxy.keystoneDoor;
            else block = BlocksCommonProxy.spellSealedDoor;
            ...
            if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack)
                ...
                if (!block.canPlaceBlockAt(par3World, par4, par5, par6)) {
                    ...
                    int i1 = MathHelper.floor_double((par2EntityPlayer.rotationYaw + 180.0F) * 4.0F / 360.0F - 0.5D)
                        & 3;
    ...
    public static void placeDoorBlock(World par0World, int par1, int par2, int par3, int par4, Block par5Block) {
        ...
        int i1 = (par0World.isBlockNormalCubeDefault(par1 - b0, par2, par3 - b1, true) ? 1 : 0)
            + (par0World.isBlockNormalCubeDefault(par1 - b0, par2 + 1, par3 - b1, true) ? 1 : 0);
        int j1 = (par0World.isBlockNormalCubeDefault(par1 + b0, par2, par3 + b1, true) ? 1 : 0)
            + (par0World.isBlockNormalCubeDefault(par1 + b0, par2 + 1, par3 + b1, true) ? 1 : 0);
