...
public class ContainerKeystone extends Container {
    ...
    public ItemStack[] GetFullRuneBagInventory() {
        ...
        for (int i = keyStoneInventory.inventorySize; i
            < keyStoneInventory.inventorySize + runeBag.inventorySize; ++i) {
        ...
        if (!world.isRemote) {
            ...
            if (runeBagStack != null) {
                ...
                entityplayer.inventory.setInventorySlotContents(
                    InventoryUtilities.getInventorySlotIndexFor(entityplayer.inventory, ItemsCommonProxy.runeBag),
                    runebagItemStack);
            }
        }
    ...
    public boolean setInventoryToCombination(int comboIndex) {
        ...
        while (matchIndex < combo.metas.length
            && searchIndex < InventoryKeyStone.inventorySize + (runeBag != null ? InventoryRuneBag.inventorySize : 0)) {
