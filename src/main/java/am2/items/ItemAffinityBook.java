...
public class ItemAffinityBook extends ArsMagicaItem {
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        textures = new String[] { "affinity_tome_general", "affinity_tome_arcane", "affinity_tome_water",
            "affinity_tome_fire", "affinity_tome_earth", "affinity_tome_air", "affinity_tome_lightning",
            "affinity_tome_ice", "affinity_tome_nature", "affinity_tome_life", "affinity_tome_ender" };
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        if (par1ItemStack.getItemDamage() == META_GENERAL) {
            ...
            AffinityData.For(par3EntityPlayer)
                .incrementAffinity(Affinity.getByID(par1ItemStack.getItemDamage()), 20);
        }

        if (!par2World.isRemote) par1ItemStack.stackSize--;
