...
public class ItemCrystalPhylactery extends ArsMagicaItem {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        if (par1ItemStack.hasTagCompound()) {
            ...
            if (className != null) {
                par3List.add(
                    String.format(
                        StatCollector.translateToLocal("am2.tooltip.phyEss"),
                        StatCollector.translateToLocal("entity." + className + ".name")));
    ...
    public void setSpawnClass(ItemStack stack, Class clazz) {
        ...
        if (s != null) stack.stackTagCompound.setString("SpawnClassName", s);
    }
