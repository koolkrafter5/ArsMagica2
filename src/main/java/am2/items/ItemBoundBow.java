...
public class ItemBoundBow extends ItemBow implements IBoundItem {
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int slotIndex, boolean par5) {
        if (par3Entity instanceof EntityPlayer) {
            ...
            if (par1ItemStack.getItemDamage() > 0) par1ItemStack.damageItem(-1, (EntityLivingBase) par3Entity);
        }
    }

    @Override
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
        p_77659_3_.setItemInUse(p_77659_1_, this.getMaxItemUseDuration(p_77659_1_)); // do not need a real arrow to fire
                                                                                     // it - it's a magic manifestation,
                                                                                     // after all
        return p_77659_1_;
    }
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_) {
        ...
        EntityBoundArrow entityarrow = new EntityBoundArrow(
            p_77615_2_,
            p_77615_3_,
            f * 2.0F,
            getApplicationStack(p_77615_1_));
    ...
    @Override
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) { // you can apply the effect
                                                                                            // just by hitting someone
                                                                                            // with the bow (or by
                                                                                            // shooting them!)
