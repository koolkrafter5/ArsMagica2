...
public class ItemEtheriumExtractor extends ArsMagicaItem {
    ...
    @Override
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int x, int y, int z,
        int side, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
        ...
        if (!p_77648_2_.canPlayerEdit(x, y, z, side, p_77648_1_)) {
            ...
            if (p_77648_3_.getBlock(x, y, z) instanceof BlockWitchwoodLog
                && !(p_77648_3_.getBlock(x, y, z) instanceof BlockWitchwoodLogDrained)) {
                p_77648_1_.damageItem(1, p_77648_2_);
                p_77648_3_.playSoundEffect(
                    (double) x + 0.5D,
                    (double) y + 0.5D,
    ...
    private void fillPlayerEth(EntityPlayer player) {
            ...
            if (player.inventory.getStackInSlot(i) != null) {
                if (player.inventory.getStackInSlot(i)
                    ...
                    if (player.inventory.getStackInSlot(i).stackSize-- == 1) {
                        ...
                        if (!player.inventory.addItemStackToInventory(new ItemStack(ItemsCommonProxy.itemAMBucket))) {
        ...
        player.worldObj
            .setBlock((int) player.posX, (int) player.posY - 1, (int) player.posZ, BlocksCommonProxy.liquidEssence);
    }
}
