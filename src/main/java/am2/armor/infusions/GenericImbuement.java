...
public class GenericImbuement implements IArmorImbuement {
    ...
    public static void registerAll() {
        // all armors
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(
                manaRegen,
                0,
                ImbuementTiers.FIRST,
                new int[] { ImbuementRegistry.SLOT_BOOTS, ImbuementRegistry.SLOT_LEGS, ImbuementRegistry.SLOT_CHEST,
                    ImbuementRegistry.SLOT_HELM }));
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(
                burnoutReduction,
                1,
        ...
        // chest
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(flickerLure, 3, ImbuementTiers.FIRST, new int[] { ImbuementRegistry.SLOT_CHEST }));
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(magicXP, 15, ImbuementTiers.FOURTH, new int[] { ImbuementRegistry.SLOT_CHEST }));

        // helmet
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(pinpointOres, 16, ImbuementTiers.FIRST, new int[] { ImbuementRegistry.SLOT_HELM }));
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(
                magitechGoggleIntegration,
                17,
                ImbuementTiers.FIRST,
                new int[] { ImbuementRegistry.SLOT_HELM }));
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(
                thaumcraftNodeReveal,
                2,
                ImbuementTiers.FOURTH,
                new int[] { ImbuementRegistry.SLOT_HELM }));

        // legs
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(stepAssist, 21, ImbuementTiers.FIRST, new int[] { ImbuementRegistry.SLOT_LEGS }));

        // boots
        ImbuementRegistry.instance.registerImbuement(
            new GenericImbuement(runSpeed, 26, ImbuementTiers.FIRST, new int[] { ImbuementRegistry.SLOT_BOOTS }));
    }
