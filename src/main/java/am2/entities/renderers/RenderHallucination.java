...
public class RenderHallucination extends RenderLiving {
    ...
    public void renderLivingHallucination(EntityHallucination HallucinationEntity, double par2, double par4,
        double par6, float par8, float par9) {
        if (Minecraft.getMinecraft().thePlayer.getCommandSenderName()
            .equals(HallucinationEntity.getTargetName()))
    ...
    protected void preRenderHallucination(EntityHallucination HallucinationEntity, float par2) {
        if (HallucinationEntity instanceof EntitySpecificHallucinations.EntityHallucinationWitherSkeleton)
