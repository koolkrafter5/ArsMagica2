...
public class RenderManaVortex extends Render {
    ...
    private static final ResourceLocation vortex = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getCustomBlockTexturePath("Magic_Fabricator_2.png"));
    private static final ResourceLocation wisp = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("mob_wisp.png"));
    ...
    private void doRenderManaVortex(EntityManaVortex vortex, double d, double d1, double d2, float f, float f1) {
        ...
        renderArsMagicaEffect(
            tessellator,
            vortex.ticksExisted,
            vortex.getTicksToExist(),
            vortex.getRotation(),
            vortex.getScale(),
            vortex.getManaStolenPercent());
    ...
    private void renderArsMagicaEffect(Tessellator tessellator, int ticks, int life, float rotation, float scale,
        ...
        for (int var7 = 0; var7 < (var4 + var4 * var4) / 2.0F * 60.0F; ++var7) {
            ...
            tessellator.setColorRGBA(
                ...
                (int) (255 - (percent * 255)),
                (int) (255 - (percent * 255)),
                (int) (255.0F * (0.2F - (var5 * 0.2f))));
            tessellator.addVertex(0.0D, 0.0D, 0.0D);
            // tessellator.setColorRGBA_I(color, 0);
            tessellator
                .setColorRGBA((int) (percent * 255), (int) (255 - (percent * 255)), (int) (255 - (percent * 255)), 0);
