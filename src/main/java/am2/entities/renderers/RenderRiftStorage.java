...
public class RenderRiftStorage extends Render {
    ...
    private static final ResourceLocation rift = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("Rift.png"));
    private static final ResourceLocation rift2 = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("Rift2.png"));
    ...
    public void renderRift(EntityRiftStorage entityRiftStorage, double d, double d1, double d2, float f, float f1) {
        ...
        GL11.glScalef(
            ...
            entityRiftStorage.getScale(1) * 2,
            entityRiftStorage.getScale(0) * 2);
