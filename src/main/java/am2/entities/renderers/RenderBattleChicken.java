...
public class RenderBattleChicken extends RenderLiving {
    ...
    private static final ResourceLocation rLoc = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("battleChicken.png"));

    public RenderBattleChicken(ModelBase par1ModelBase, float par2) {
        super(par1ModelBase, par2);
    }

    public void renderChicken(EntityBattleChicken par1EntityChicken, double par2, double par4, double par6, float par8,
        float par9) {
    ...
    protected float getWingRotation(EntityBattleChicken par1EntityChicken, float par2) {
        float f1 = par1EntityChicken.field_70888_h
            + (par1EntityChicken.field_70886_e - par1EntityChicken.field_70888_h) * par2;
        float f2 = par1EntityChicken.field_70884_g
