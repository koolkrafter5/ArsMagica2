...
public class RenderWaterElemental extends RenderBiped {
    ...
    private static final ResourceLocation rLoc = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("mobWaterElemental.png"));
    ...
    public void func_82426_a(EntityWaterElemental dryad, double par2, double par4, double par6, float par8,
        float par9) {
