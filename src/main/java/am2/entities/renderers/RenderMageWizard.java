...
public class RenderMageWizard extends RenderLiving {
    ...
    private static final ResourceLocation rLoc = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("light_mages/wizard_villager3.png"));
    ...
    public void func_82412_a(EntityMageVillager par1EntityMageVillager, double par2, double par4, double par6,
