...
public class EntityAirSled extends EntityLiving {
        ...
        if (worldObj.isRemote) {
            ...
            if (this.worldObj.isAirBlock((int) this.posX, (int) (this.posY - 1), (int) this.posZ)) {
                for (int i = 0; i < AMCore.config.getGFXLevel(); ++i) {
                    AMParticle cloud = (AMParticle) AMCore.proxy.particleManager
                        .spawn(worldObj, "sparkle2", posX, posY + 0.5, posZ);
                    if (cloud != null) {
    ...
    public void moveEntityWithHeading(float par1, float par2) {
        if (this.riddenByEntity != null) {
            ...
            if (!this.onGround && !this.isInWater()) this.motionY = -0.1f;
            else this.motionY = 0f;
        ...
        if (this.riddenByEntity != null) this.setSize(0.5f, 3);
        this.moveEntity(this.motionX, this.motionY, this.motionZ);
        if (this.riddenByEntity != null) this.setSize(0.5f, 1);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2) {
        if (this.ridingEntity != null) this.ridingEntity.mountEntity(null);
        return false;
    }
}
