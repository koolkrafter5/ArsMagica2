...
public class EntityBroom extends EntityCreature {
    ...
    private void updateRotations() {
        if (isMoving()) {
            ...
            if (((int) (moveCounter)) % 6 == 0) {
                // TODO: worldObj.playSoundAtEntity(this, .soundGrassFootstep.stepSoundName, 10.6f,
            ...
            if (moveRotation > 0) {
                moveRotation -= 0.1f;
                if (moveRotation < 0) moveRotation = 0;
    ...
    public void writeToNBT(NBTTagCompound nbttagcompound) {
        ...
        if (chestLocation != null) nbttagcompound
            .setIntArray("chestLoc", new int[] { (int) chestLocation.x, (int) chestLocation.y, (int) chestLocation.z });
    }
    ...
    public void readFromNBT(NBTTagCompound nbttagcompound) {
        ...
        if (chestLoc.length == 3) chestLocation = new AMVector3(chestLoc[0], chestLoc[1], chestLoc[2]);
        else chestLocation = new AMVector3(posX, posY, posZ);
    }
