...
public class EntityAIApplyPotionOnCollide extends EntityAIBase {
    ...
    public EntityAIApplyPotionOnCollide(EntityCreature par1EntityLiving, Class par2Class, float par3,
        PotionEffect template, boolean par4) {
    ...
    public boolean shouldExecute() {
        ...
        if (var1 == null) {
            ...
            this.field_75438_g = this.attacker.getNavigator()
    ...
    public boolean continueExecuting() {
        ...
        return var1 == null ? false
            : (!this.entityTarget.isEntityAlive() ? false
                : (!this.field_75437_f ? !this.attacker.getNavigator()
                    .noPath()
    ...
    public void startExecuting() {
        this.attacker.getNavigator()
            .setPath(this.field_75438_g, this.field_75440_e);
    ...
    public void updateTask() {
        this.attacker.getLookHelper()
            .setLookPositionWithEntity(this.entityTarget, 30.0F, 30.0F);

        if ((this.field_75437_f || this.attacker.getEntitySenses()
            .canSee(this.entityTarget)) && --this.field_75445_i <= 0) {
            this.field_75445_i = 4 + this.attacker.getRNG()
                .nextInt(7);
            this.attacker.getNavigator()
                .tryMoveToEntityLiving(this.entityTarget, this.field_75440_e);
        }
        ...
        if (this.attacker
            .getDistanceSq(this.entityTarget.posX, this.entityTarget.boundingBox.minY, this.entityTarget.posZ)
            <= var1) {
            if (this.attackTick <= 0) {
                ...
                try {
                    ...
                    LogHelper.trace(
                        "Entity AI Potion On Collide Error {0}",
                        e1.getStackTrace()
                            .toString());
                ...
                if (ctor != null) {
                    ...
                    try {
                        pe = ctor
                            .newInstance(_template.getPotionID(), _template.getDuration(), _template.getAmplifier());
