...
public class EntityAIWaterElementalAttack extends EntityAIBase {
    ...
    public EntityAIWaterElementalAttack(EntityCreature par1EntityLiving, Class par2Class, float par3,
        int attackStrength, boolean par4) {
    ...
    public void updateTask() {
        ...
        if (this.attacker
            ...
            if (this.attackTick <= 0) {
                ...
                for (var7 = attacker.posZ - entityTarget.posZ; var9 * var9 + var7 * var7
