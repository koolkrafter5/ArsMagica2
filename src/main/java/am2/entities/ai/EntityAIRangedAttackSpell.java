...
public class EntityAIRangedAttackSpell extends EntityAIBase {
    ...
    public EntityAIRangedAttackSpell(EntityCreature host, float moveSpeed, int cooldown, String shape,
        String[] components, String[] modifiers) {
        rangedAttackTime = 0;
        field_48367_f = 0;
        entityHost = host;
    ...
    public void updateTask() {
        ...
        if (d1 > d || field_48367_f > 20) {
            ...
            if (!entityHost.getNavigator()
                .tryMoveToXYZ(newX, attackTarget.posY, newZ, 0.5f)) {
