...
public class MageVillagerTrade implements IVillageTradeHandler {
    ...
    public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random) {
        ...
        for (int i = 0; i < numChoices; ++i) {
            ...
            if (choice != null) {
                MerchantRecipe itemToSell = new MerchantRecipe(
                    new ItemStack(Items.emerald, random.nextInt(Math.abs(max - min) + min) + 1),
                    choice);
    ...
    private ItemStack getRandomChoiceForTrade(Random random) {
        ...
        if (itemSeed < 150) {
            // essence
            weightedRandomChoices
                .put(new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_ARCANEASH), 1000);
            for (int i = 0; i < 13; ++i)
                if (i == 11) weightedRandomChoices.put(new ItemStack(ItemsCommonProxy.essence, 1, i), 250);
                else weightedRandomChoices.put(new ItemStack(ItemsCommonProxy.essence, 1, i), 120);
            ...
            /*
             * if (choice.getItem() == ItemsCommonProxy.archmageHood || choice.getItem() ==
             * ItemsCommonProxy.archmageArmor || choice.getItem() == ItemsCommonProxy.archmageBoots || choice.getItem()
             * == ItemsCommonProxy.archmageLeggings){
             * min = 13;
             * max = 21;
             * }else
             */
            if (choice.getItem() == ItemsCommonProxy.battlemageHood
                || choice.getItem() == ItemsCommonProxy.battlemageArmor
                || choice.getItem() == ItemsCommonProxy.battlemageBoots
                || choice.getItem() == ItemsCommonProxy.battlemageLeggings) {
                min = 8;
                max = 17;
            } else if (choice.getItem() == ItemsCommonProxy.mageHood || choice.getItem() == ItemsCommonProxy.mageArmor
                || choice.getItem() == ItemsCommonProxy.mageBoots
                || choice.getItem() == ItemsCommonProxy.mageLeggings) {
                    min = 4;
                    max = 9;
                } else {
                    min = 2;
