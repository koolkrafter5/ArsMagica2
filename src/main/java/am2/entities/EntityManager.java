...
public class EntityManager implements IEntityManager {
    ...
    public void initializeSpawns() {
        ...
        SpawnListEntry manaElementals = new SpawnListEntry(
            EntityManaElemental.class,
        ...
        SpawnListEntry hecates_nonHell = new SpawnListEntry(
            EntityHecate.class,
            AMCore.config.GetHecateSpawnRate(),
            1,
            1);
        SpawnListEntry hecates_hell = new SpawnListEntry(
            EntityHecate.class,
            AMCore.config.GetHecateSpawnRate() * 2,
            1,
            2);
        SpawnListEntry manaCreepers = new SpawnListEntry(
            EntityManaCreeper.class,
        ...
        SpawnListEntry waterElementals = new SpawnListEntry(
            EntityWaterElemental.class,
        ...
        SpawnListEntry earthElementals = new SpawnListEntry(
            EntityEarthElemental.class,
            AMCore.config.GetEarthElementalSpawnRate(),
            1,
            2);
        SpawnListEntry fireElementals = new SpawnListEntry(
            EntityFireElemental.class,
        ...
        initSpawnsForBiomeTypes(
            ...
            new Type[] { Type.BEACH, Type.SANDY, Type.FOREST, Type.SNOWY, Type.HILLS, Type.JUNGLE, Type.MAGICAL,
        ...
        initSpawnsForBiomeTypes(
            ...
            new Type[] { Type.BEACH, Type.FOREST, Type.MAGICAL, Type.HILLS, Type.JUNGLE, Type.MOUNTAIN, Type.PLAINS },
            new Type[] { Type.END, Type.SNOWY, Type.MUSHROOM, Type.NETHER, Type.WASTELAND, Type.SWAMP, Type.SANDY,
                Type.DEAD, Type.WASTELAND });
    ...
    private void initSpawnsForBiomeTypes(SpawnListEntry spawnListEntry, EnumCreatureType creatureType, Type[] types,
        ...
        if (spawnListEntry.itemWeight == 0) {
            LogHelper.info(
                ...
                spawnListEntry.entityClass.getName(),
    ...
    private void initSpawnsForBiomes(BiomeGenBase[] biomes, SpawnListEntry spawnListEntry,
        EnumCreatureType creatureType, Type[] exclusions) {
        if (biomes == null) return;
        for (BiomeGenBase biome : biomes) {
            if (biomeIsExcluded(biome, exclusions)) continue;
            if (!biome.getSpawnableList(creatureType)
                .contains(spawnListEntry))
    ...
    public void addButcheryBlacklist(Class... clazz) {
        for (Class l_clazz : clazz) SpawnBlacklists.addButcheryBlacklist(l_clazz);
    }

    @Override
    public void addProgenyBlacklist(Class... clazz) {
        for (Class l_clazz : clazz) SpawnBlacklists.addProgenyBlacklist(l_clazz);
    }
}
