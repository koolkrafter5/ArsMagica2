...
public class EntityRiftStorage extends EntityLiving {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer) {
        ...
        RiftStorage.For(par1EntityPlayer)
            .setAccessEntity(this);
        FMLNetworkHandler.openGui(
            par1EntityPlayer,
            AMCore.instance,
            ArsMagicaGuiIdList.GUI_RIFT,
            par1EntityPlayer.worldObj,
            (int) par1EntityPlayer.posX,
            (int) par1EntityPlayer.posY,
            (int) par1EntityPlayer.posZ);
        return true;
    }
