...
public class ExtendedProperties implements IExtendedProperties, IExtendedEntityProperties {
        ...
        try {
            if (this.entity instanceof EntityPlayer) {
                if (this.entity.getActivePotionEffect(BuffList.manaBoost) != null) {
                    max *= 1 + (0.25 * (this.entity.getActivePotionEffect(BuffList.manaBoost)
                        .getAmplifier() + 1));
                }
            }
    ...
    public byte[] getUpdateData() {
        ...
        if ((this.updateFlags & UPD_BETA_PARTICLES) == UPD_BETA_PARTICLES && entity instanceof EntityPlayer
            && AMCore.proxy.playerTracker.hasAA((EntityPlayer) entity)) {
                ...
                if (currentFatigue > 50) { // lvl 5+
                    ...
                    if (roll == 0) {
                        ...
                        if (!this.entity.worldObj.isRemote) {
                            List entitiesNear = this.entity.worldObj.getEntitiesWithinAABBExcludingEntity(
                                this.entity,
                    ...
                    if (roll == 0) {
                        ...
                        for (int i = 0; i < 100; i++) {
                            ...
                            if (this.entity.worldObj.isAirBlock((int) x, (int) y, (int) z)
                                ...
                                float f2 = (random.nextFloat() - 0.5F) * 0.2F;
                                this.entity.worldObj
                                    .spawnParticle("portal", x, y, z, (double) f, (double) f1, (double) f2);
                                break;
                            }
                        }
                    }
    ...
    public void setMagicLevel(int magicLevel) {
        ...
        ticksForFullRegen = (int) Math
            .round(baseTicksForFullRegen * (0.75 - (0.25 * (getMagicLevel() / maxMagicLevel))));
    ...
    public boolean handleDataPacket(byte[] data) {
        ...
        if ((flags & UPD_MANALINK) == UPD_MANALINK) {
            ...
            for (int i = 0; i < numLinks; ++i) {
                ...
                if (e != null && e instanceof EntityLivingBase) updateManaLink((EntityLivingBase) e);
            }
        }
    ...
    public void toggleFlipped() {
        ...
        if (this.getIsFlipped()) this.setIsFlipped(false);
        else this.setIsFlipped(true);
    }
        ...
        if (ticksSinceLastRegen >= ticksToRegen) {
            ...
            if (getCurrentMana() < actualMaxMana) {
                if (entity instanceof EntityPlayer && ((EntityPlayer) entity).capabilities.isCreativeMode) {
                    ...
                    int regenTicks = (int) Math.ceil(
                        ticksForFullRegen * entity.getAttributeMap()
    ...
    private class ManaLinkEntry {
        ...
        private EntityLivingBase getEntity(World world) {
            ...
            if (e == null || !(e instanceof EntityLivingBase)) return null;
