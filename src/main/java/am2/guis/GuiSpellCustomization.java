...
public class GuiSpellCustomization extends GuiContainer {
    ...
    private static final ResourceLocation background = new ResourceLocation(
        "arsmagica2",
        ResourceManager.GetGuiTexturePath("SpellCustomization.png"));
    ...
    public void initGui() {
        ...
        else spellName = new GuiTextField(fontRendererObj, l + 8, i1 + 8, xSize - 16, 16);
        ...
        btnPrev = new GuiButtonVariableDims(0, l + 8, i1 + 26, StatCollector.translateToLocal("am2.gui.prev"))
            .setDimensions(48, 20);
        btnNext = new GuiButtonVariableDims(1, l + xSize - 56, i1 + 26, StatCollector.translateToLocal("am2.gui.next"))
            .setDimensions(48, 20);
        ...
        if (AMCore.config.suggestSpellNames()) this.buttonList.add(btnRandomName);
