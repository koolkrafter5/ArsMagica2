...
public class GuiBlockAccess implements IBlockAccess {
    ...
    public Block getBlock(int i, int j, int k) {
        if (i == overridex && j == overridey && k == overridez) return this.fakeBlock;
        if (outerBlockAccess != null) return outerBlockAccess.getBlock(i, j, k);
        return Blocks.air;
    }
    ...
    public TileEntity getTileEntity(int i, int j, int k) {
        ...
        if (outerBlockAccess != null) return outerBlockAccess.getTileEntity(i, j, k);
        return null;
    }
    ...
    public int getLightBrightnessForSkyBlocks(int i, int j, int k, int l) {
        if (outerBlockAccess != null) return outerBlockAccess.getLightBrightnessForSkyBlocks(i, j, k, l);
        return 15728704;
    }

    @Override
    public int getBlockMetadata(int i, int j, int k) {
        if (i == overridex && j == overridey && k == overridez) return this.fakeBlockMeta;
        if (outerBlockAccess != null) return outerBlockAccess.getBlockMetadata(i, j, k);
        return 0;
    }
