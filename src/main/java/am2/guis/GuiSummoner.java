...
public class GuiSummoner extends GuiContainer {
    ...
    private static final ResourceLocation background = new ResourceLocation(
        "arsmagica2",
        ResourceManager.GetGuiTexturePath("SummonerGui.png"));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        String readyString = summonerInventory.canSummon() ? StatCollector.translateToLocal("am2.gui.summonReady")
            : StatCollector.translateToLocal("am2.gui.summonNotReady");
        color = summonerInventory.canSummon() ? 0x007700 : 0x770000;

        fontRendererObj
            .drawString(readyString, xSize / 2 - (fontRendererObj.getStringWidth(readyString) / 2), ySize - 107, color);
    }
