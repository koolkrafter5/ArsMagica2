...
public class GuiButtonCompendiumTab extends GuiButton {
    ...
    private static final ResourceLocation buttonImage = new ResourceLocation(
        "arsmagica2",
        "textures/guis/ArcaneCompendiumIndexGui.png");
    private static final ResourceLocation RES_ITEM_GLINT = new ResourceLocation(
        "textures/misc/enchanted_item_glint.png");

    public GuiButtonCompendiumTab(int id, int xPos, int yPos, String categoryDisplay, String categoryID,
        IIcon displayIcon) {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        if (this.visible) {
            ...
            if (hasNew) {
                ...
                AMGuiHelper.DrawIconAtXY(
                    AMParticleIcons.instance.getIconByName("lights"),
                    this.xPosition + (this.width / 3) - 1,
                    this.yPosition + 1,
                    this.zLevel,
                    16,
                    16,
            ...
            if (displayIcon != null) {
                ...
                Minecraft.getMinecraft().fontRenderer
                    .drawString(this.displayString, this.xPosition + (this.width / 4), this.yPosition + 2, 0x000000);
            }
