...
public class GuiButtonSkillTreeTab extends GuiButton {
    ...
    public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
        if (this.visible) {
            ...
            this.drawTexturedModalRect_Classic(
                ...
                IIconDims,
                IIconDims);
            if (isActive) this.drawTexturedModalRect_Classic(
                this.xPosition,
                this.yPosition + this.buttonHeight,
                this.buttonWidth,
                v,
                buttonWidth,
                7,
    ...
    public void drawTexturedModalRect_Classic(double dst_x, double dst_y, int src_x, int src_y, int dst_width,
        int dst_height, int src_width, int src_height) {
