...
public class GuiButtonCompendiumLink extends GuiButton {
    ...
    public GuiButtonCompendiumLink(int id, int xPos, int yPos, FontRenderer fontRenderer, String text, String entryID,
        String category, boolean hasSubItems, int pageNum) {
        ...
        if (this.visible) {
            ...
            if (isNewItem) {
                ...
                AMGuiHelper.instance
                    .DrawIconAtXY(AMGuiIcons.newEntry, xPosition - 6, yPosition + 2, this.zLevel, 5, 5, true);
            }
