...
public class GuiSlideControl extends GuiButton {
    ...
    public void setMaximum(float maximum) {
        ...
        if (this.sliderValue > sliderMax) this.sliderValue = sliderMax;
    }
    ...
    protected void mouseDragged(Minecraft par1Minecraft, int par2, int par3) {
        if (this.visible) {
            ...
            if (this.isVertical) {
                this.drawTexturedModalRect(
                    xPos,
                    this.yPosition + (int) (this.sliderValue / scale * (this.height - this.buttonH)),
                    buttonUL,
                    buttonVL,
                    buttonW,
                    buttonH);
                ...
                this.drawTexturedModalRect(
                    this.xPosition + (int) (this.sliderValue * (this.width - buttonW * 2)),
                    yPos,
                    buttonUL,
                    buttonVL,
                    buttonW,
                    buttonH);
                this.drawTexturedModalRect(
                    this.xPosition + (int) (this.sliderValue * (this.width - buttonW * 2)) + buttonW,
                    yPos,
                    buttonUR,
                    buttonVR,
                    buttonW,
