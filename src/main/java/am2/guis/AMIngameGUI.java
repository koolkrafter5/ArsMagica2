...
public class AMIngameGUI {
    ...
    private void RenderSpellBookUI(int i, int j, FontRenderer fontrenderer, ItemStack bookStack) {
        ...
        for (int n = 0; n < 8; ++n) {
            ...
            int d = 12;
            DrawIconAtXY(
                ((ItemSpellBase) stackItem.getItem()).getIconFromDamageForRenderPass(stackItem.getItemDamage(), 0),
                "items",
                IIconX,
                spellUI_y + 1.5f,
                d,
                ...
                false);
            DrawIconAtXY(
                ((ItemSpellBase) stackItem.getItem()).getIconFromDamageForRenderPass(stackItem.getItemDamage(), 1),
                "items",
                IIconX,
                spellUI_y + 1.5f,
                d,
