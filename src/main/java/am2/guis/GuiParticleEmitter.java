...
public class GuiParticleEmitter extends GuiScreen {
    ...
    public void initGui() {
        ...
        btnParticleColorMode = new GuiButtonVariableDims(
            ...
            50,
            80,
            tile.getColorDefault() ? StatCollector.translateToLocal("am2.gui.default")
                : tile.getColorRandom() ? StatCollector.translateToLocal("am2.gui.random")
                    : StatCollector.translateToLocal("am2.gui.custom"));
        hideBlock = new GuiButtonVariableDims(
            19,
            50,
            100,
            tile.getShow() ? StatCollector.translateToLocal("am2.gui.visible")
                : StatCollector.translateToLocal("am2.gui.hidden"));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (!tile.getShow()) {
            fontRendererObj
                .drawSplitString(StatCollector.translateToLocal("am2.gui.wrenchWarning"), 10, 125, 100, 0xff0000);
        }
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        ...
        switch (par1GuiButton.id) {
            ...
            case 19: // hide/show
                flag = tile.getShow();
                tile.setShow(!flag);
                hideBlock.displayString = !flag ? StatCollector.translateToLocal("am2.gui.visible")
                    : StatCollector.translateToLocal("am2.gui.hidden");
                break;
            case 20: // quantity
