        ...
        for (int i = 0; i < childNodes.getLength(); ++i) {
            ...
            if (child.getNodeName()
                ...
                && !child.getTextContent()
                    .isEmpty()) {
                String[] modifierTypes = child.getTextContent()
                    .split(",");
                ...
                for (String s : modifierTypes) {
                    try {
                        ...
                        LogHelper
                            .debug("Compendium Parsing Error - No modifiable constant exists with the name '%s'", s);
                    }
                }
    ...
    public ItemStack getRepresentItemStack(String searchID, int meta) {
        ...
        if (entry != null) {
            return new ItemStack(
                ...
                1,
                SkillManager.instance.getShiftedPartID(entry.registeredItem));
        }
        return null;
    }
