...
public class RenderUtilities {
    ...
    public static void DrawIconInWorldAtOffset(IIcon icon, double x, double y, double z, double width, double height) {
        ...
        if (view < 2) GL11.glRotatef(-RenderManager.instance.playerViewX, 1.0F, 0.0F, 0.0F);
        else GL11.glRotatef(RenderManager.instance.playerViewX, 1.0F, 0.0F, 0.0F);
    ...
    private static void renderIcon(IIcon IIcon, int renderColor) {
        ...
        tessellator.setColorRGBA_F(
            (renderColor & 0xFF0000) >> 16,
            (renderColor & 0x00FF00) >> 8,
            renderColor & 0x0000FF,
            AMGuiHelper.instance.playerRunesAlpha);
