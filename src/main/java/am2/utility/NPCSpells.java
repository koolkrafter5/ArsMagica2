...
public class NPCSpells {
    ...
    private NPCSpells() {
        ...
        SpellUtils.instance.addSpellStageToScroll(
            lightMage_DiminishedAttack,
            "Projectile",
            new String[] { "PhysicalDamage" },
            new String[] {});

        lightMage_NormalAttack = new ItemStack(ItemsCommonProxy.spell);
        SpellUtils.instance.addSpellStageToScroll(
            lightMage_NormalAttack,
            "Projectile",
            new String[] { "FrostDamage", "Slow" },
            new String[] {});

        lightMage_AugmentedAttack = new ItemStack(ItemsCommonProxy.spell);
        SpellUtils.instance.addSpellStageToScroll(
            lightMage_AugmentedAttack,
            "Projectile",
            new String[] { "MagicDamage", "Blind" },
            new String[] { "Damage" });

        darkMage_DiminishedAttack = new ItemStack(ItemsCommonProxy.spell);
        SpellUtils.instance.addSpellStageToScroll(
            darkMage_DiminishedAttack,
            "Projectile",
            new String[] { "MagicDamage" },
            new String[] {});
        ...
        SpellUtils.instance.addSpellStageToScroll(
            darkMage_NormalAttack,
            "Projectile",
            new String[] { "FireDamage", "Ignition" },
            new String[] {});

        darkMage_AugmentedAttack = new ItemStack(ItemsCommonProxy.spell);
        SpellUtils.instance.addSpellStageToScroll(
            darkMage_AugmentedAttack,
            "Projectile",
            new String[] { "LightningDamage", "Knockback" },
            new String[] { "Damage" });

        enderGuardian_enderWave = new ItemStack(ItemsCommonProxy.spell);
        SpellUtils.instance.addSpellStageToScroll(
            enderGuardian_enderWave,
            "Wave",
            new String[] {},
        ...
        SpellUtils.instance.addSpellStageToScroll(
            enderGuardian_enderWave,
            "Touch",
            new String[] { "MagicDamage", "Knockback" },
            new String[0]);
        ...
        SpellUtils.instance.addSpellStageToScroll(
            enderGuardian_enderBolt,
            "Projectile",
            new String[] { "MagicDamage", "RandomTeleport" },
            new String[] { "Damage" });
        ...
        SpellUtils.instance.addSpellStageToScroll(
            enderGuardian_otherworldlyRoar,
            "AoE",
            new String[] { "Blind", "Silence", "Knockback" },
            new String[] { "Radius", "Radius", "Radius", "Radius", "Radius" });
        ...
        SpellUtils.instance.addSpellStageToScroll(
            enderGuardian_enderTorrent,
            "Projectile",
            new String[] { "Silence", "Knockback" },
            new String[] { "Speed" });
        SpellUtils.instance.addSpellStageToScroll(
            enderGuardian_enderTorrent,
            "AoE",
            new String[] { "ManaDrain", "LifeDrain" },
            new String[] {});
        ...
        SpellUtils.instance
            .addSpellStageToScroll(arcaneBolt, "Projectile", new String[] { "MagicDamage" }, new String[0]);
        ...
        SpellUtils.instance
            .addSpellStageToScroll(waterBolt, "Projectile", new String[] { "WateryGrave", "Drown" }, new String[0]);

        fireBolt = new ItemStack(ItemsCommonProxy.spell);
        SpellUtils.instance
            .addSpellStageToScroll(fireBolt, "Projectile", new String[] { "FireDamage", "Ignition" }, new String[0]);
        ...
        SpellUtils.instance.addSpellStageToScroll(
            nauseate,
            "Projectile",
            new String[] { "Nauseate", "ScrambleSynapses" },
            new String[0]);
        ...
        SpellUtils.instance
            .addSpellStageToScroll(lightningRune, "AoE", new String[] { "LightningDamage" }, new String[] { "Damage" });
        ...
        SpellUtils.instance.addSpellStageToScroll(
            scrambleSynapses,
            "Projectile",
            new String[] { "LightningDamage" },
            new String[] { "Speed" });
        SpellUtils.instance.addSpellStageToScroll(
            scrambleSynapses,
            "AoE",
            new String[] { "ScrambleSynapses" },
            new String[] { "Radius", "Radius", "Radius", "Radius", "Radius" });
