...
public class Beam implements ISpellShape {
        ...
        if (world.isRemote && beamHitVec != null) {
            ...
            if (beam != null) {
                ...
                if (affinity == Affinity.LIGHTNING) {
                    AMCore.instance.proxy.particleManager.BoltFromEntityToPoint(
                        world,
                        caster,
                        beamHitVec.xCoord,
                        beamHitVec.yCoord,
                    ...
                    beam = (AMBeam) AMCore.instance.proxy.particleManager.BeamFromEntityToPoint(
                        world,
                        caster,
                        beamHitVec.xCoord,
                        beamHitVec.yCoord,
                        ...
                        color == -1 ? affinity.color : color);
                    if (beam != null) {
                        if (AMCore.instance.proxy.getProxyUtils()
    ...
    public Object[] getRecipeItems() {
        return new Object[] { ItemsCommonProxy.standardFocus,
            ...
            BlocksCommonProxy.aum, String.format("E:%d", PowerTypes.NEUTRAL.ID()), 500 };
    }
