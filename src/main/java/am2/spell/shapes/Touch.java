...
public class Touch implements ISpellShape {
        ...
        if (mop == null) {
            ...
            if (mop.typeOfHit == MovingObjectType.ENTITY) {
                ...
                SpellCastResult result = SpellHelper.instance
                    .applyStageToEntity(stack, caster, world, (target == null) ? e : target, 0, giveXP);
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_VINTEUMDUST),
            Items.feather, Items.fish, Items.clay_ball };
    }
