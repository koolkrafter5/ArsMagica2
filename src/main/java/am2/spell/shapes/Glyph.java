...
public class Glyph implements ISpellShape {
        ...
        if (caster.isSneaking()) { // set glyphs
            if (!world.isRemote) {
                ...
                if (ep.hasExtraVariable("SPELLPOS")) {
                    if (caster instanceof EntityPlayer && SkillData.For((EntityPlayer) caster)
                        .isEntryKnown(
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_WHITE),
            ...
            new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_AIR), Items.feather, Items.arrow,
