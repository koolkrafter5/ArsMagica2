...
public class Contingency_Death implements ISpellShape {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { Items.clock,
            new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_ENDER), Blocks.stone,
            Blocks.stone_slab, Blocks.stone_slab, Blocks.stone_slab, Items.blaze_powder, BlocksCommonProxy.tarmaRoot,
