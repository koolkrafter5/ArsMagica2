...
public class TargetNonSolidBlocks implements ISpellModifier {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_WATER),
            Items.potionitem, Blocks.red_flower, Blocks.brown_mushroom, BlocksCommonProxy.cerublossom };
    }
