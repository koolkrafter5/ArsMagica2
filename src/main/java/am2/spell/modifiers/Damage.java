...
public class Damage implements ISpellModifier {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_ENDER),
            new ItemStack(BlocksCommonProxy.sanguineAmaryllis), Items.iron_sword, "P:!0 & !1 & 2 & 3" // harming potion
        };
    }
