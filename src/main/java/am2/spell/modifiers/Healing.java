...
public class Healing implements ISpellModifier {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_LIFE),
            new ItemStack(BlocksCommonProxy.effervescentSnowdrop), Items.egg, "P:0 & !1 & 2 & !3" // healing potion
        };
    }
