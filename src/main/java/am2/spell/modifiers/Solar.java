...
public class Solar implements ISpellModifier {
    ...
    public float getModifier(SpellModifiers type, EntityLivingBase caster, Entity target, World world,
        ...
        return (float) Math
            .max(1, Math.pow(Math.pow((burnoutRatio * spellBonus), (burnoutRatio + 1)), (burnoutRatio + 1)) * 5);
    }
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_NATURE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SUNSTONE), Items.clock };
    }
