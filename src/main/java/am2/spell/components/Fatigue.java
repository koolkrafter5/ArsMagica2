...
public class Fatigue implements ISpellComponent, IRitualInteraction {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_GRAY), Items.clay_ball,
            Items.coal };
    }
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(Items.slime_ball), new ItemStack(Items.snowball) };
    }
