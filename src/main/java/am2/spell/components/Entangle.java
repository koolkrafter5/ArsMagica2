...
public class Entangle implements ISpellComponent, IRitualInteraction {
    ...
    public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
        if (target instanceof EntityLivingBase) {
            int duration = 140 + SpellUtils.instance.getModifiedInt_Mul(
                BuffList.default_buff_duration / 10,
                stack,
                caster,
                target,
                world,
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_GREEN), Blocks.vine,
            Items.slime_ball };
    }
