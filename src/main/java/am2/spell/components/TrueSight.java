...
public class TrueSight implements ISpellComponent, IRitualInteraction {
        ...
        for (int i = 0; i < 25; ++i) {
            ...
            if (particle != null) {
                ...
                particle.AddParticleController(
                    new ParticleOrbitEntity(particle, target, 0.1f, 2, false).setOrbitY(0.5)
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_BLUE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_CHIMERITE), Blocks.glass_pane };
    }
