...
public class Reflect implements ISpellComponent {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_WHITE), Blocks.glass,
            Blocks.iron_block, BlocksCommonProxy.witchwoodLog };
    }
