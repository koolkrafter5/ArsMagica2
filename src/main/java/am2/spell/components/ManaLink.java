...
public class ManaLink implements ISpellComponent, IRitualInteraction {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { BlocksCommonProxy.manaBattery, BlocksCommonProxy.essenceConduit,
            ItemsCommonProxy.crystalWrench, ItemsCommonProxy.manaFocus };
    }
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_MOONSTONE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SUNSTONE),
            new ItemStack(BlocksCommonProxy.tarmaRoot), new ItemStack(BlocksCommonProxy.wakebloom),
            new ItemStack(BlocksCommonProxy.desertNova), new ItemStack(ItemsCommonProxy.itemAMBucket),
            new ItemStack(ItemsCommonProxy.legendaryManaPotion), new ItemStack(ItemsCommonProxy.manaFocus), };
    }
    ...
    public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
        ...
        AMLineArc arc = (AMLineArc) AMCore.proxy.particleManager
            .spawn(world, "textures/blocks/wipblock2.png", caster, target);
        if (arc != null) {
