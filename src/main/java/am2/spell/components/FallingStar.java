...
public class FallingStar implements ISpellComponent {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_ARCANE),
            ...
            BlocksCommonProxy.manaBattery, Items.lava_bucket };
    }
    ...
    private boolean spawnStar(ItemStack spellStack, EntityLivingBase caster, Entity target, World world, double x,
        ...
        List<EntityThrownRock> rocks = world.getEntitiesWithinAABB(
            EntityThrownRock.class,
            AxisAlignedBB.getBoundingBox(x - 10, y - 10, z - 10, x + 10, y + 10, z + 10));

        int damageMultitplier = SpellUtils.instance
            .getModifiedInt_Mul(15, spellStack, caster, target, world, 0, SpellModifiers.DAMAGE);

        for (EntityThrownRock rock : rocks) {
            if (rock.getIsShootingStar()) return false;
        }
