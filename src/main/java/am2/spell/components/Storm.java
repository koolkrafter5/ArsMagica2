...
public class Storm implements ISpellComponent {
        ...
        if (rainStrength > 0.9D) {
            if (!world.isRemote) {
                ...
                if (random < 20) {
                    ...
                    if (mob instanceof Entity target
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_YELLOW),
            ...
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_RAINROCKROSE), Items.ghast_tear };
    }
