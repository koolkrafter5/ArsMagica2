...
public class Hunger implements ISpellComponent, IRitualInteraction {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_BROWN),
            Items.rotten_flesh, Items.poisonous_potato, Items.chicken };
    }
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(Blocks.web), new ItemStack(Items.coal) };
    }
