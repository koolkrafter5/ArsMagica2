...
public class Fury implements ISpellComponent, IRitualInteraction {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { Items.fish, Items.fish, Items.fish, Items.fish, Items.fish, Items.fish, Items.fish,
            Items.fish, Items.fish, Items.fish, Items.fish, Items.fish, Items.fish,
        ...
        for (int i = 0; i < 5 * AMCore.config.getGFXLevel(); ++i) {
            ...
            if (particle != null) {
                ...
                particle.AddParticleController(
                    new ParticleOrbitEntity(particle, target, 0.15f, 1, false)
                        .SetTargetDistance(world.rand.nextDouble() + 1f)
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(Items.potionitem, 1, 8194), new ItemStack(Items.potionitem, 1, 8201) };
    }
