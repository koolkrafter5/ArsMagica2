...
public class Flight implements ISpellComponent, IRitualInteraction {
    ...
    public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
        ...
        for (int i = 0; i < 15; ++i) {
            AMParticle particle = (AMParticle) AMCore.proxy.particleManager
                .spawn(world, rand.nextBoolean() ? "wind" : "ember", x, y, z);
            if (particle != null) {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_WHITE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_CELESTIALFISH), Items.nether_star,
            Items.ghast_tear };
    }
