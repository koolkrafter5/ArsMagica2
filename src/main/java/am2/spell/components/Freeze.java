...
public class Freeze implements ISpellComponent, IRitualInteraction {
    ...
    public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
        ...
        for (int i = 0; i < 5; ++i) {
            AMParticle particle = (AMParticle) AMCore.proxy.particleManager
                .spawn(world, "snowflakes", x + 0.5, y + 0.5, z + 0.5);
            if (particle != null) {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_BLUE), Blocks.snow };
    }
