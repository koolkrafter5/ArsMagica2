...
public class Attract implements ISpellComponent {
    ...
    private boolean doTK_Extrapolated(ItemStack stack, World world, double impactX, double impactY, double impactZ,
        ...
        EntityLivingBase target = getClosestEntityToPointWithin(
            caster,
            world,
            new AMVector3(impactX, impactY, impactZ),
            16);
        ...
        AMVector3 movement = MathUtilities
            .GetMovementVectorBetweenPoints(new AMVector3(target), new AMVector3(impactX, impactY, impactZ));
    ...
    private EntityLivingBase getClosestEntityToPointWithin(EntityLivingBase caster, World world, AMVector3 point,
        double radius) {
