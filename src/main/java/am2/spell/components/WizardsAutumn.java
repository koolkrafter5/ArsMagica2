...
public class WizardsAutumn implements ISpellComponent {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { Blocks.sapling, new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_GREEN),
    ...
    public boolean applyEffectBlock(ItemStack stack, World world, int blockx, int blocky, int blockz, int blockFace,
        ...
        if (!world.isRemote) {
            int radius = 2;
            radius = SpellUtils.instance
                .getModifiedInt_Add(radius, stack, caster, caster, world, 0, SpellModifiers.RADIUS);
