...
public class Plant implements ISpellComponent {
    ...
    public boolean applyEffectBlock(ItemStack stack, World world, int blockx, int blocky, int blockz, int blockFace,
        ...
        if (soil != Blocks.air && seeds.size() > 0) {
            ...
            if (soil != null && soil.canSustainPlant(world, blockx, blocky, blockz, ForgeDirection.UP, seed)
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_GREEN),
            Items.wheat_seeds, new ItemStack(Blocks.sapling, 1, Short.MAX_VALUE), Items.wheat_seeds };
    }
