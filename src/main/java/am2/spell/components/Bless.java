...
public class Bless implements ISpellComponent {
                    ...
                    if (lastBuffEffect) {
                        target.addPotionEffect(
                            buffEffectFromPotionID(
                                ...
                                Math.max(targetAmplifier, magnitudeCost)));
                    } else {
                        target.addPotionEffect(
                            new PotionEffect(
                                potionID,
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_PINK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_ARCANEASH),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_BLUETOPAZ), Items.golden_apple };
    }
