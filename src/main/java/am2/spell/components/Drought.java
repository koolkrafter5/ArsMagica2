...
public class Drought implements ISpellComponent {
    ...
    public void spawnParticles(World world, double x, double y, double z, EntityLivingBase caster, Entity target,
        ...
        for (int i = 0; i < 25; ++i) {
            AMParticle particle = (AMParticle) AMCore.proxy.particleManager
                .spawn(world, "ember", x + 0.5, y + 1, z + 0.5);
            if (particle != null) {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_ORANGE),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_HELLFISH), Blocks.sand,
            Blocks.deadbush };
    }

    @Override
    public float getAffinityShift(Affinity affinity) {
        if (affinity == Affinity.FIRE) return 0.008f;
        else return 0.004f;
    }
