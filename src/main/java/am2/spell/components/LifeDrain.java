...
public class LifeDrain implements ISpellComponent {
    ...
    public boolean applyEffectEntity(ItemStack stack, World world, EntityLivingBase caster, Entity target) {
        ...
        boolean success = SpellHelper.instance.attackTargetSpecial(
            stack,
            target,
            DamageSource.causeIndirectMagicDamage(caster, caster),
            SpellUtils.instance.modifyDamage(caster, magnitude));
