...
public class ManaShield implements ISpellComponent, IRitualInteraction {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { ItemsCommonProxy.manaFocus, ItemsCommonProxy.battlemageArmor,
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_ARCANE),
