...
public class Silence implements ISpellComponent {
    ...
    public Object[] getRecipeItems() {
        return new Object[] { Blocks.wool,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_ARCANEASH),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_IMBUEDMOONFLOWER), Blocks.jukebox,
            Blocks.wool };
    }
