...
public class Recall implements ISpellComponent, IRitualInteraction {
    ...
    private boolean handleRitualReagents(ItemStack[] ritualRunes, World world, int x, int y, int z,
        ...
        for (ItemStack stack : ritualRunes) {
            if (stack.getItem() == ItemsCommonProxy.itemOre
                && stack.getItemDamage() == ItemsCommonProxy.itemOre.META_VINTEUMDUST) {
                hasVinteumDust = true;
                break;
            }
        }
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_ORANGE), Items.compass,
