...
public class Saturation implements ISpellComponent, IRitualInteraction {
        ...
        if (target instanceof EntityLivingBase) {
            ...
            if (!world.isRemote) ((EntityLivingBase) target).addPotionEffect(
                new PotionEffect(
                    ...
                    duration,
                    SpellUtils.instance.countModifiers(SpellModifiers.BUFF_POWER, stack, 0))); // saturation
            return true;
        }
        return false;
    }
    ...
    public Object[] getRecipeItems() {
        return new Object[] { new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_ORANGE),
            Items.cooked_beef, Items.cooked_chicken, Items.cooked_fished, Items.cooked_porkchop, Items.cookie, };
    }
    ...
    public ItemStack[] getReagents() {
        return new ItemStack[] { new ItemStack(Blocks.torch), new ItemStack(Items.coal),
            new ItemStack(Items.water_bucket), new ItemStack(Items.milk_bucket), };
    }
