...
public class RenderLightningGuardian extends RenderBoss {
    ...
    private static final ResourceLocation lightning = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/lightning_guardian_lt.png"));
    private static final ResourceLocation armor = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getMobTexturePath("bosses/lightning_guardian.png"));
