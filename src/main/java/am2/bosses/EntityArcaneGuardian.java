...
public class EntityArcaneGuardian extends AM2Boss {
    ...
    private void updateRotations() {
        ...
        if (targetRuneRotationY > runeRotationY) runeRotationY += runeRotationSpeed;
        else if (targetRuneRotationY < runeRotationY) runeRotationY -= runeRotationSpeed;
    ...
    protected void initSpecificAI() {
        ...
        this.tasks.addTask(
            ...
            new EntityAICastSpell(
                this,
                NPCSpells.instance.healSelf,
                16,
                23,
                60,
                BossActions.CASTING,
                new ISpellCastCallback<EntityArcaneGuardian>() {
        ...
        this.tasks
            .addTask(3, new EntityAICastSpell(this, NPCSpells.instance.arcaneBolt, 12, 23, 5, BossActions.CASTING));
    }
