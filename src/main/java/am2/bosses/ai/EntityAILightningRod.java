...
public class EntityAILightningRod extends AIAnimation {
    ...
    public void updateTask() {
        ...
        if (ticks <= 25) {
            ...
            if (target != null) startPos = new AMVector3(target);
        } else {
            ...
            if (ticks > 85 && ticks <= 150) {
                if (!guardian.worldObj.isRemote && ticks % 20 == 0) guardian.worldObj.playSoundAtEntity(
                    guardian,
            ...
            if (ticks > 25 && ticks <= 85) {
                ...
                if (!guardian.worldObj.isRemote && ticks == 30) guardian.worldObj.playSoundAtEntity(
                    guardian,
                ...
                if (!guardian.worldObj.isRemote && ticks % 20 == 0) guardian.worldObj.playSoundAtEntity(
                    guardian,
                    "arsmagica2:mob.lightningguardian.idle",
                    1.0f,
                    guardian.getRNG()
                        .nextFloat() * 0.5f + 0.5f);
