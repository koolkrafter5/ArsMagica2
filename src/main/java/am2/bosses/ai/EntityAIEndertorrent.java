    ...
    public void updateTask() {
        ...
        if (guardian.getAttackTarget() != null) {
            ...
            if (guardian.getTicksInCurrentAction() > 15) {
                if ((guardian.getTicksInCurrentAction() - 15) % 10 == 0) SpellHelper.instance.applyStackStage(
                    NPCSpells.instance.enderGuardian_enderTorrent,
                    guardian,
                    null,
                    guardian.posX,
                    guardian.posY,
                ...
                guardian.worldObj.playSoundAtEntity(
                    guardian,
                    "arsmagica2:mob.enderguardian.roar",
                    1.0f,
                    (float) (0.5 + guardian.getRNG()
                        .nextDouble() * 0.5f));
            } else {
