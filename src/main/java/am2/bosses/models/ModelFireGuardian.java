    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (entity instanceof EntityFireGuardian) {
            if (((EntityFireGuardian) entity).getIsUnderground()
                && ((EntityFireGuardian) entity).getCurrentAction() != BossActions.SPINNING) return;
            GL11.glPushMatrix();
        ...
        switch (entity.getCurrentAction()) {
            case SPINNING:
                ...
                if (!entity.getIsUnderground()) {
                    if (entity.getTicksInCurrentAction() > stage) {
                        float offset = 3
                            * ((entity.getTicksInCurrentAction() + (f2 - entity.ticksExisted) - stage) / 5);
                ...
                if (entity.getTicksInCurrentAction() > stage) {
                    float rotation = 180
                        * ((entity.getTicksInCurrentAction() + (f2 - entity.ticksExisted) - stage) / 20);
            ...
            case LONG_CASTING:
                ...
                if (entity.getTicksInCurrentAction() < action_ticks) {
                    rightArmRotation = (float) Math.toRadians(
                        -max_degrees_x
