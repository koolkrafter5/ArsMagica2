        ...
        switch (guardian.getCurrentAction()) {
            case CASTING:
                ...
                if (ticksInCurrentAction < action_ticks) {
                    right_arm_rotation_x = (float) Math
                        .toRadians(-max_degrees_x * (ticksInCurrentAction / action_ticks));
            ...
            case SPINNING:
                max_degrees_x = 180;
                float degrees = ticksInCurrentAction < 20 ? max_degrees_x * (ticksInCurrentAction / 20f)
                    : max_degrees_x;
