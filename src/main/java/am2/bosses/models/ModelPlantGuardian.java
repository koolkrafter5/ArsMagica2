        ...
        switch (guardian.getCurrentAction()) {
            ...
            case SPINNING:
                float degrees = guardian.getTicksInCurrentAction() < 20
                    ? 60f * (((float) guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted)) / 20f)
                    : 60;
            ...
            case STRIKE:
                ...
                if (guardian.getTicksInCurrentAction() < action_ticks) {
                    main_arm_rotation_x = (float) Math.toRadians(
                        -max_degrees_x * (((float) guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted))
                            / action_ticks));
                    main_arm_rotation_y = (float) Math.toRadians(
                        max_degrees_y * (((float) guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted))
                            / action_ticks));
                } else if (guardian.getTicksInCurrentAction() < (action_ticks + fast_action_ticks)) {
                    main_arm_rotation_x = (float) Math.toRadians(
                        -max_degrees_x + (max_degrees_x
                            * ((float) (guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted)
                                - action_ticks) / fast_action_ticks)));
                    main_arm_rotation_y = (float) Math.toRadians(
                        max_degrees_y - (max_degrees_y
                            * ((float) (guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted)
                                - action_ticks) / fast_action_ticks)));
                }
            ...
            case SHIELD_BASH:
                ...
                if (guardian.getTicksInCurrentAction() < action_ticks) {
                    ...
                    shield_arm_rotation_y = (float) Math.toRadians(
                        -max_degrees_y * (((float) guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted))
                            / action_ticks));
                } else if (guardian.getTicksInCurrentAction() < (action_ticks + fast_action_ticks)) {
                    // main_arm_rotation_x = (float) Math.toRadians(-max_degrees_x + (max_degrees_x *
                    // ((float)(guardian.getTicksInCurrentAction() - action_ticks) / fast_action_ticks)));
                    shield_arm_rotation_y = (float) Math.toRadians(
                        -max_degrees_y + (max_degrees_y
                            * ((float) (guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted)
                                - action_ticks) / fast_action_ticks)));
