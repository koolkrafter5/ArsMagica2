        ...
        switch (guardian.getCurrentAction()) {
            case SMASH:
                ...
                if (guardian.getTicksInCurrentAction() < action_ticks) {
                    left_arm_rotation_x = (float) Math.toRadians(
                    ...
                    float pct = ((float) (guardian.getTicksInCurrentAction() + (f2 - guardian.ticksExisted)
            ...
            case STRIKE:
                ...
                if (guardian.getTicksInCurrentAction() < action_ticks) {
                    ...
                    if (guardian.hasLeftArm()) GL11.glRotatef(40 * pct, 0, 1, 0);
                    else GL11.glRotatef(-40 * pct, 0, 1, 0);
                }
