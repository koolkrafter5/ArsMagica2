    ...
    private void updateRotations(EntityWaterGuardian guardian, float f, float f1, float f2, float f3, float f4,
        ...
        switch (guardian.getCurrentAction()) {
            ...
            case CASTING:
                ...
                if (ticks < 11) degrees = maxAngle * (ticks / 10f);
                else if (ticks < 18) degrees = maxAngle;
                else if (guardian.getCurrentAction() == BossActions.CASTING) degrees = maxAngle * ((23 - ticks) / 5f);
                else if (ticks < 150) degrees = maxAngle;
                else degrees = maxAngle * ((160 - ticks) / 10f);
