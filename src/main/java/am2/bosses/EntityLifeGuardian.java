...
public class EntityLifeGuardian extends AM2Boss {
    ...
    protected void initSpecificAI() {
        ...
        this.tasks.addTask(
            ...
            new EntityAICastSpell(
                ...
                100,
                BossActions.CASTING,
                new ISpellCastCallback<EntityLifeGuardian>() {
    ...
    protected float modifyDamageAmount(DamageSource source, float damageAmt) {
        if (minions.size() > 0) {
            damageAmt = 0;
            minions.get(getRNG().nextInt(minions.size()))
                .attackEntityFrom(source, damageAmt);
        }
        return damageAmt;
    }
    ...
    public void onUpdate() {
        ...
        if (!worldObj.isRemote) {
            ...
            while (it.hasNext()) {
                ...
                if (minion == null || minion.isDead) it.remove();
            }
        ...
        if (this.ticksExisted % 40 == 0) this.heal(2f);
