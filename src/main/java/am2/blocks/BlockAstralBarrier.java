...
public class BlockAstralBarrier extends AMSpecialRenderPoweredBlock {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
        ...
        if (!par1World.isRemote) if (KeystoneUtilities
            .HandleKeystoneRecovery(par5EntityPlayer, ((IKeystoneLockable) par1World.getTileEntity(par2, par3, par4))))
            return true;
            ...
            if (par5EntityPlayer.isSneaking()) {
                ...
                if (!par1World.isRemote) {
                    ...
                    FMLNetworkHandler.openGui(
                        par5EntityPlayer,
                        AMCore.instance,
                        ArsMagicaGuiIdList.GUI_ASTRAL_BARRIER,
                        par1World,
                        par2,
                        par3,
                        par4);
