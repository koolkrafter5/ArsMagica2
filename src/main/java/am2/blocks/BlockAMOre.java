...
public class BlockAMOre extends BlockOre {
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        textures = new String[] { "orevinteum", "orechimerite", "orebluetopaz", "oremoonstone", "oresunstone",
            "oreblockmoonstone", "oreblockvinteum", "oreblockbluetopaz", "oreblocksunstone", "oreblockchimerite" };
            ...
            case META_CHIMERITE_ORE:
                drops.add(
                    new ItemStack(
                        ...
                        world.rand.nextInt(4) + 1 + fortune,
                        ItemsCommonProxy.itemOre.META_CHIMERITE));
                break;
            case META_MOONSTONE_ORE:
                drops.add(
                    new ItemStack(
                        ItemsCommonProxy.itemOre,
                        world.rand.nextInt(2) + 1 + fortune,
                        ItemsCommonProxy.itemOre.META_MOONSTONE));
                break;
            case META_SUNSTONE_ORE:
                drops.add(
                    new ItemStack(
                        ItemsCommonProxy.itemOre,
                        world.rand.nextInt(3) + 2 + fortune,
                        ItemsCommonProxy.itemOre.META_SUNSTONE));
                break;
            case META_BLUE_TOPAZ_ORE:
                drops.add(
                    new ItemStack(
                        ItemsCommonProxy.itemOre,
                        world.rand.nextInt(4) + 1 + fortune,
                        ItemsCommonProxy.itemOre.META_BLUETOPAZ));
                break;
            default:
