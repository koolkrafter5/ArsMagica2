...
public class BlockEssenceRefiner extends PoweredBlock {
    ...
    private IIcon[] icons;
    private String[] textureNames = { "essence_refiner_side", "essence_refiner_top", "essence_refiner_front_idle",
        "essence_refiner_front_active" };
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
        ...
        if (!par1World.isRemote) {
            if (KeystoneUtilities.HandleKeystoneRecovery(
                par5EntityPlayer,
                ((IKeystoneLockable) par1World.getTileEntity(par2, par3, par4)))) return true;
            if (KeystoneUtilities.instance.canPlayerAccess(
                ...
                FMLNetworkHandler.openGui(
                    par5EntityPlayer,
                    AMCore.instance,
                    ArsMagicaGuiIdList.GUI_ESSENCE_REFINER,
                    par1World,
                    par2,
                    par3,
                    par4);
