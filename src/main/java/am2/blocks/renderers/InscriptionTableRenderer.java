...
public class InscriptionTableRenderer extends TileEntitySpecialRenderer {
    ...
    public static final ResourceLocation inscriptionTableTexture = new ResourceLocation(
        "arsmagica2",
        ResourceManager.getCustomBlockTexturePath("InscriptionTable.png"));
    ...
    public void renderAModelAt(TileEntityInscriptionTable tile, double d, double d1, double d2, float f) {
        ...
        if (d == 0 && d1 == 0 && d2 == 0) {
            ...
            if ((i & 0x8) == 0x8) modelLeft.renderModel(0.0625F, tile.getUpgradeState()); // renders and yes 0.0625 is a
                                                                                          // random number
            else modelRight.renderMode(0.0625F, tile.getUpgradeState());
        }
