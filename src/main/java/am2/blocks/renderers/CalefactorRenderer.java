...
public class CalefactorRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderAModelAt(TileEntityCalefactor tile, double d, double d1, double d2, float f) {
        ...
        if (tile.xCoord == 0 && tile.yCoord == 0 && tile.zCoord == 0) GL11.glTranslatef(0, 0.2f, 0);

        model.renderModel(tile.getRotationX(), tile.getRotationY(), tile.getRotationZ(), 0.0625F); // renders and yes
                                                                                                   // 0.0625 is a random
                                                                                                   // number
