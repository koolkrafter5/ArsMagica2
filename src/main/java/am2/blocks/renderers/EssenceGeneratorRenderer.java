...
public class EssenceGeneratorRenderer extends TileEntitySpecialRenderer {
    ...
    public EssenceGeneratorRenderer() {
        ...
        rLoc_obelisk_active = new ResourceLocation(
            "arsmagica2",
            ResourceManager.getCustomBlockTexturePath("obelisk_active.png"));
        rLoc_obelisk_active_highpower = new ResourceLocation(
            "arsmagica2",
            ResourceManager.getCustomBlockTexturePath("obelisk_active_highpower.png"));
        rLoc_obelisk_runes = new ResourceLocation(
            "arsmagica2",
            ResourceManager.getCustomBlockTexturePath("obelisk_runes.png"));
        rLoc_celestial = new ResourceLocation(
            "arsmagica2",
            ResourceManager.getCustomBlockTexturePath("celestial_prism.png"));
    ...
    public void renderAModelAt(TileEntityObelisk tile, double d, double d1, double d2, float f) {
        ...
        if (tile instanceof TileEntityCelestialPrism) renderCelestial((TileEntityCelestialPrism) tile, d, d1, d2, f);
        else if (tile instanceof TileEntityBlackAurem) renderBlackAurem((TileEntityBlackAurem) tile, d, d1, d2, f);
        else renderObelisk(tile, d, d1, d2, f);
    ...
    private void renderObelisk(TileEntityObelisk tile, double d, double d1, double d2, float f) {
        ...
        if (tile.isHighPowerActive()) bindTexture(rLoc_obelisk_active_highpower);
        else if (tile.isActive()) bindTexture(rLoc_obelisk_active);
        else bindTexture(rLoc_obelisk);
