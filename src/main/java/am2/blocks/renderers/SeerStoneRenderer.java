...
public class SeerStoneRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderAModelAt(TileEntitySeerStone tile, double d, double d1, double d2, float f) {
        ...
        if (tile.ShouldAnimate()) RenderEye(PowerTypes.NEUTRAL, tile.getAnimationIndex(), d, d1, d2, meta);
    }
    ...
    private void RenderEye(PowerTypes powerType, int index, double d, double d1, double d2, int meta) {
        ...
        if (powerType == PowerTypes.DARK) GL11.glColor4f(1.0f, 0.0f, 0.0f, 1.0f);
        else if (powerType == PowerTypes.LIGHT) GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        else if (powerType == PowerTypes.NEUTRAL) GL11.glColor4f(0.0f, 0.2f, 1.0f, 1.0f);
