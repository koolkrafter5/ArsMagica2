...
public class LecternRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityArchmagePodiumAt(TileEntityLectern podium, double d, double d1, double d2, float f1) {
        int meta = 0;
        if (podium.getWorldObj() != null) meta = podium.getWorldObj()
            .getBlockMetadata(podium.xCoord, podium.yCoord, podium.zCoord) - 1;
        ...
        if (podium.hasStack()) {
            if (podium.getOverpowered()) GL11.glColor4f(0.7f, 0.2f, 0.2f, 1.0f);
    ...
    private void renderHelperIcon(TileEntityLectern podium, double d, double d1, double d2, float f) {
        ...
        ItemStack stack = podium.getTooltipStack()
            .copy();
        stack.stackSize = 1;
        AMGuiHelper.instance.dummyItem.setEntityItemStack(stack);
        renderItem.doRender(
            AMGuiHelper.instance.dummyItem,
            d + 0.5f,
            d1 + 1.4f,
            d2 + 0.5f,
            AMGuiHelper.instance.dummyItem.rotationYaw,
            f);
    ...
    private void renderRadiant(Tessellator tessellator, float partialFrame, TileEntityLectern podium) {
        ...
        for (int var7 = 0; var7 < 20.0F; ++var7) {
            ...
            if (!podium.getOverpowered()) tessellator.setColorRGBA_F(0.2f, 0.2f, 1.0f, 0.2f);
            else tessellator.setColorRGBA_F(1.0f, 0.2f, 0.2f, 0.2f);
            tessellator.addVertex(0.0D, 0.0D, 0.0D);
            if (!podium.getOverpowered()) tessellator.setColorRGBA_F(0.2f, 0.2f, 1.0f, 0.0f);
            else tessellator.setColorRGBA_F(1.0f, 0.2f, 0.2f, 0.0f);
    ...
    private void RenderBook(TileEntityLectern p_147539_1_, double p_147539_2_, double p_147539_4_, double p_147539_6_,
        float p_147539_8_, int meta) {
        GL11.glPushMatrix();
        ...
        for (f2 = p_147539_1_.field_145928_o - p_147539_1_.field_145925_p; f2
        ...
        bindTexture(book);
        float var12 = p_147539_1_.field_145931_j
            + (p_147539_1_.field_145933_i - p_147539_1_.field_145931_j) * p_147539_8_
            + 0.25F;
        float var13 = p_147539_1_.field_145931_j
            + (p_147539_1_.field_145933_i - p_147539_1_.field_145931_j) * p_147539_8_
            + 0.75F;
        ...
        float var14 = p_147539_1_.field_145927_n
            + (p_147539_1_.field_145930_m - p_147539_1_.field_145927_n) * p_147539_8_;
     ...
     * float f2;
     * for (f2 = p_147539_1_.field_145928_o - p_147539_1_.field_145925_p; f2 >= (float)Math.PI; f2 -= ((float)Math.PI *
     * 2F))
     * {
     * ;
     * }
     ...
     * float f4 = p_147539_1_.field_145931_j + (p_147539_1_.field_145933_i - p_147539_1_.field_145931_j) * p_147539_8_ +
     * 0.25F;
     * float f5 = p_147539_1_.field_145931_j + (p_147539_1_.field_145933_i - p_147539_1_.field_145931_j) * p_147539_8_ +
     * 0.75F;
