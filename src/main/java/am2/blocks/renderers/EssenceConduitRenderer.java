...
public class EssenceConduitRenderer extends TileEntitySpecialRenderer {
    ...
    public EssenceConduitRenderer() {
        ...
        unPowered = new ResourceLocation(
            "arsmagica2",
            ResourceManager.getCustomBlockTexturePath("essenceConduitUnpowered.png"));
    }
    ...
    public void renderAModelAt(TileEntityEssenceConduit tile, double d, double d1, double d2, float f) {
        ...
        model.renderModel(tile.getRotationX(), tile.getRotationY(), tile.getRotationZ(), 0, 0.0625F); // renders and yes
                                                                                                      // 0.0625 is a
                                                                                                      // random number
