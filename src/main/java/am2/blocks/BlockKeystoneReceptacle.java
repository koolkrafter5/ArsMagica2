...
public class BlockKeystoneReceptacle extends AMSpecialRenderPoweredBlock {
    ...
    public boolean onBlockActivated(World par1World, int x, int y, int z, EntityPlayer par5EntityPlayer, int par6,
        ...
        if (par5EntityPlayer.isSneaking()) {
            if (!par1World.isRemote
                && KeystoneUtilities.instance.canPlayerAccess(receptacle, par5EntityPlayer, KeystoneAccessType.USE)) {
                FMLNetworkHandler.openGui(
                    par5EntityPlayer,
                    AMCore.instance,
                    ArsMagicaGuiIdList.GUI_KEYSTONE_LOCKABLE,
                    par1World,
                    x,
                    y,
                    z);
            ...
            if (receptacle.canActivate()) {
                ...
                if (par5EntityPlayer.inventory.getCurrentItem() != null && par5EntityPlayer.inventory.getCurrentItem()
                    .getItem() == ItemsCommonProxy.evilBook) {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLiving,
        ...
        TileEntityKeystoneRecepticle receptacle = (TileEntityKeystoneRecepticle) par1World
