    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
        ...
        if (!par1World.isRemote) {
            ...
            FMLNetworkHandler.openGui(
                par5EntityPlayer,
                AMCore.instance,
                ArsMagicaGuiIdList.GUI_ARMOR_INFUSION,
                par1World,
                par2,
                par3,
                par4);
             ...
             * return true;
             * if (KeystoneUtilities.instance.canPlayerAccess((IKeystoneLockable)par1World.getTileEntity(par2, par3,
             * par4), par5EntityPlayer, KeystoneAccessType.USE)){
             * super.onBlockActivated(par1World, par2, par3, par4, par5EntityPlayer, par6, par7, par8, par9);
             * FMLNetworkHandler.openGui(par5EntityPlayer, AMCore.instance, ArsMagicaGuiIdList.GUI_ARMOR_INFUSION,
