...
public class BlockEntropicEnervator extends PoweredBlock {
    ...
    private IIcon[] icons;
    private String[] textureNames = { "entropic_enervator_top", "entropic_enervator_front_idle",
        "entropic_enervator_front_active" };
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
        ...
        if (!par1World.isRemote) {
            ...
            FMLNetworkHandler.openGui(
                par5EntityPlayer,
                AMCore.instance,
                ArsMagicaGuiIdList.GUI_ENERVATOR,
                par1World,
                par2,
                par3,
                par4);
