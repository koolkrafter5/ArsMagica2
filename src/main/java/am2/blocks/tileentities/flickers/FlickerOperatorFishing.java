...
public class FlickerOperatorFishing implements IFlickerFunctionality {
    ...
    private static final List common_items = Arrays.asList(
    ...
    private static final List rare_items = Arrays.asList(
    ...
    private static final List uncommon_items = Arrays.asList(
        new WeightedRandomFishable[] {
            ...
            new WeightedRandomFishable(
                ...
                13) });
    private static final List nether_items = Arrays.asList(
        new WeightedRandomFishable[] {
            new WeightedRandomFishable(
            ...
            new WeightedRandomFishable(
                ...
                5) });
    private static final List ender_items = Arrays.asList(
        new WeightedRandomFishable[] {
            new WeightedRandomFishable(
    ...
    public Object[] getRecipe() {
        return new Object[] { " F ", "N W", " R ", Character.valueOf('F'), Items.fish, Character.valueOf('W'),
            new ItemStack(ItemsCommonProxy.flickerJar, 1, Affinity.WATER.ordinal()), Character.valueOf('N'),
            new ItemStack(ItemsCommonProxy.flickerJar, 1, Affinity.NATURE.ordinal()), Character.valueOf('R'),
