...
public class FlickerOperatorGentleRains implements IFlickerFunctionality {
    ...
    public boolean DoOperation(World worldObj, IFlickerController habitat, boolean powered) {
        ...
        if (!worldObj.isRemote) {
            ...
            while (!worldObj.isAirBlock(effectX, effectY, effectZ)
                && worldObj.getBlock(effectX, effectY, effectZ) != Blocks.farmland
                && effectY > 0) {
                effectY++;
            }
    ...
    public Object[] getRecipe() {
        return new Object[] { " B ", "CWT", " B ", Character.valueOf('C'), BlocksCommonProxy.essenceConduit,
            Character.valueOf('T'), BlocksCommonProxy.tarmaRoot, Character.valueOf('W'),
            new ItemStack(ItemsCommonProxy.flickerJar, 1, Affinity.WATER.ordinal()), Character.valueOf('B'),
