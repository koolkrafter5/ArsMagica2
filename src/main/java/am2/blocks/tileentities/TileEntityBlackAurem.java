...
public class TileEntityBlackAurem extends TileEntityObelisk implements IMultiblockStructureController {
    ...
    public TileEntityBlackAurem() {
        ...
        structure.addAllowedBlock(
            chimerite,
            -2,
            2,
            -2,
            BlocksCommonProxy.AMOres,
            BlocksCommonProxy.AMOres.META_CHIMERITE_BLOCK);
        ...
        structure.addAllowedBlock(obsidian, 2, 2, 2, Blocks.obsidian);
        structure
            .addAllowedBlock(sunstone, 2, 2, 2, BlocksCommonProxy.AMOres, BlocksCommonProxy.AMOres.META_SUNSTONE_BLOCK);
