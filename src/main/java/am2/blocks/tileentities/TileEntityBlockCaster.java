...
public class TileEntityBlockCaster extends TileEntityAMPower implements IInventory {
    ...
    public float getCharge() {
        ...
        for (PowerTypes type1 : PowerTypes.all()) {
            float tmpAmt = PowerNodeRegistry.For(worldObj)
                .getPower(this, type1);
            if (tmpAmt > amt) highestValid = type1;
        }
        return PowerNodeRegistry.For(this.worldObj)
            .getPower(this, highestValid);
    }
    ...
    protected void setDummyData() {
        ...
        ExtendedProperties.For(this.dummyCaster)
            .setMaxMana((float) this.capacity);
        ...
        switch (meta & 3) {
            ...
            case 2:
                ...
                this.dummyCaster.setPosition(
                    (double) ((float) this.xCoord + 0.5F),
                    (double) ((float) this.yCoord + 0.8F),
                    (double) ((float) this.zCoord + 1.01F));
                this.pointInFront = new Point3D(this.xCoord, this.yCoord, this.zCoord + 1);
                break;
            case 3:
                this.dummyCaster.rotationYaw = 270.0F;
                this.dummyCaster.setPosition(
                    (double) ((float) this.xCoord + 1.01F),
                    (double) ((float) this.yCoord + 0.8F),
                    (double) ((float) this.zCoord + 0.5F));
                this.pointInFront = new Point3D(this.xCoord + 1, this.yCoord, this.zCoord);
        }
        ...
        if (mV == 1) {
            ...
            this.dummyCaster.setPosition(
                (double) ((float) this.xCoord + 0.5F),
                (double) ((float) this.yCoord + 1.01F),
                (double) ((float) this.zCoord + 0.5F));
            ...
            this.dummyCaster.setPosition(
                (double) ((float) this.xCoord + 0.5F),
                (double) ((float) this.yCoord - 0.01F),
                (double) ((float) this.zCoord + 0.5F));
            this.pointInFront = new Point3D(this.xCoord, this.yCoord - 1, this.zCoord);
        }

        ExtendedProperties.For(this.dummyCaster)
            .setCurrentMana(this.getCharge());
    }

    public float getCastCost() {
        ItemStack castingStack = this.getCastingScrollStack();
        return castingStack != null
            ? SpellUtils.instance.getSpellRequirements(this.getCastingScrollStack(), this.dummyCaster).manaCost
            : -1.0F;
    }
    ...
    public void updateEntity() {
        if (this.worldObj != null) {
            ...
            if (this.firstTick) {
                ...
                ExtendedProperties.For(this.dummyCaster)
                    .init(this.dummyCaster, this.worldObj);
            }
            ...
            if (!this.worldObj.isBlockIndirectlyGettingPowered(this.xCoord, this.yCoord, this.zCoord)) {
                if (this.hasCast) {
                    if (this.worldObj.isRemote && castingStack != null
                        && SpellUtils.instance.spellIsChanneled(castingStack)) {
            ...
            .stopSound(
                net.minecraft.client.audio.PositionedSoundRecord.func_147674_a(
                    new ResourceLocation(
                        shape.getSoundForAffinity(
                            SpellUtils.instance.mainAffinityFor(castingStack),
                            castingStack,
                            (World) null)),
                    1.0F));
    }
    ...
    protected void tryCastSpell(ItemStack castingStack, int focusLevel) {
        ...
        if (this.getCharge() > castCost) {
            prepForActivate();
            if (SpellUtils.instance.spellIsChanneled(castingStack) && SpellHelper.instance.applyStackStageOnUsing(
                castingStack,
                caster,
                caster,
                (double) this.xCoord,
                ...
                false,
                false,
                this.activeTicks++) == SpellCastResult.SUCCESS) {
                PowerNodeRegistry.For(this.worldObj)
                    .consumePower(this, getBestType(), castCost);
                this.hasCast = true;
            } else if (!this.hasCast && SpellHelper.instance.applyStackStage(
                castingStack,
                caster,
                caster,
                (double) this.xCoord,
    ...
    private void prepForActivate() {
        ...
        ExtendedProperties.For(caster)
            .setMaxMana((float) this.capacity);
        ExtendedProperties.For(caster)
            .setCurrentMana((float) this.getCharge());
        int meta = this.worldObj.getBlockMetadata(this.xCoord, this.yCoord, this.zCoord);
