...
public class TileEntityInertSpawner extends TileEntityAMPower implements IInventory, ISidedInventory {
    ...
    public boolean canInsertItem(int slot, ItemStack stack, int face) {
        return isItemValidForSlot(slot, stack) && stack.stackSize == 1
    ...
    public void updateEntity() {
        ...
        if (!worldObj.isRemote && phylactery != null
            && phylactery.getItem() instanceof ItemCrystalPhylactery
            ...
            if (this.powerConsumed < this.SUMMON_REQ) {
                this.powerConsumed += PowerNodeRegistry.For(worldObj)
                    .consumePower(
                        this,
                        PowerTypes.DARK,
