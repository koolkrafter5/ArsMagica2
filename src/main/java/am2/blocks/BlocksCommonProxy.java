...
public class BlocksCommonProxy {
    ...
    public void removeKeystonePortal(int x, int y, int z, int dimension) {
        ...
        if (KeystonePortalLocations.containsKey(dimension)) {
            ...
            if (dimensionList.contains(location)) dimensionList.remove(location);
        }
    }
    ...
    public void InstantiateBlocks() {
        ...
        stormSawtooth = (BlockStormSawtooth) new BlockStormSawtooth()
            .setUnlocalizedNameAndID("arsmagica2:stormSawtooth");
        imbuedMoonflower = (BlockImbuedMoonflower) new BlockImbuedMoonflower()
            .setUnlocalizedNameAndID("arsmagica2:imbuedMoonflower");
    ...
    public void InitRecipes() {
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { " C ", " S ", "SSS", Character.valueOf('S'), "stone", Character.valueOf('C'),
                    "gemChimerite" }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "SRS", "AVA", "SFS", Character.valueOf('A'), "arcaneAsh", Character.valueOf('S'),
                    "stone", Character.valueOf('F'),
                    new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SOULFRAGMENT),
                    Character.valueOf('R'), "dustRedstone", Character.valueOf('V'), "dustVinteum" }));

        // caster rune
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(casterRune, 1),
                new Object[] { "RRR", "APA", "SVS", Character.valueOf('A'), "arcaneAsh", Character.valueOf('S'),
                    "stone", Character.valueOf('V'), "dustVinteum", Character.valueOf('R'), ItemsCommonProxy.rune,
                    Character.valueOf('P'),
                    new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SOULFRAGMENT) }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "SVS", "EPE", "SVS", Character.valueOf('P'),
                    new ItemStack(ItemsCommonProxy.essence, 1, 9), Character.valueOf('S'), Blocks.stonebrick,
                    Character.valueOf('E'), Items.ender_eye, Character.valueOf('V'), "dustVinteum" }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { " E ", "SRS", Character.valueOf('S'), "stone", // stone wall
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "WRW", "WVW", "WRW", Character.valueOf('W'), "plankWood", Character.valueOf('R'),
                    new ItemStack(ItemsCommonProxy.rune, 1, 0), Character.valueOf('V'), "dustVinteum" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(blockLectern),
                new Object[] { "SSS", " P ", Character.valueOf('S'), "slabWood", Character.valueOf('P'),
                    "plankWood" }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "SWS", "VDV", "SOS", Character.valueOf('S'), "stone", Character.valueOf('V'),
                    ...
                    BlocksCommonProxy.magicWall, Character.valueOf('O'), Blocks.obsidian }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(arcaneDeconstructor),
                new Object[] { "IGR", "WDW", "CWC", Character.valueOf('I'), ItemsCommonProxy.itemFocus,
                    Character.valueOf('G'), "blockGlassColorless", Character.valueOf('R'),
                    new ItemStack(ItemsCommonProxy.essence, 1, ItemsCommonProxy.essence.META_PURE),
                    Character.valueOf('W'), witchwoodPlanks, Character.valueOf('D'), ItemsCommonProxy.deficitCrystal,
                    Character.valueOf('C'),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "CIV", "SSS", Character.valueOf('C'), "gemChimerite", Character.valueOf('I'),
                    "ingotIron", Character.valueOf('V'), "dustVinteum", Character.valueOf('S'), Blocks.stonebrick }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "TPF", "SSS", "W W", Character.valueOf('T'), Blocks.torch, Character.valueOf('P'),
                    ItemsCommonProxy.spellParchment, Character.valueOf('F'), Items.feather, Character.valueOf('S'),
                    "slabWood", Character.valueOf('W'), "plankWood" }));

        GameRegistry.addRecipe(
            new ItemStack(Blocks.stonebrick, 1, 3),
            new Object[] { "SS", "SS", Character.valueOf('S'), Blocks.stonebrick });
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "RRR", "RVR", "RRR", Character.valueOf('R'), "dustRedstone", Character.valueOf('V'),
                    "dustVinteum" }));

        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ironInlay, 4, 0),
                new Object[] { "III", "IVI", "III", Character.valueOf('I'), "ingotIron", Character.valueOf('V'),
                    "arcaneAsh" }));
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { " C ", "CIC", " C ", Character.valueOf('I'), illusionBlock, Character.valueOf('C'),
                    "gemChimerite" }));

        GameRegistry
            .addRecipe(new ItemStack(witchwoodPlanks, 4), new Object[] { "W", Character.valueOf('W'), witchwoodLog });

        RecipeUtilities.addShapedRecipeFirst(
            recipes,
            new ItemStack(witchwoodSingleSlab, 6),
            new Object[] { "WWW", Character.valueOf('W'), witchwoodPlanks });

        RecipeUtilities.addShapedRecipeFirst(
            recipes,
            new ItemStack(witchwoodStairs, 4),
            new Object[] { "  W", " WW", "WWW", Character.valueOf('W'), witchwoodPlanks });
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "COC", "SWS", "LHL", Character.valueOf('C'), "craftingTableWood", Character.valueOf('O'),
                    new ItemStack(Blocks.carpet), Character.valueOf('W'), "logWood", Character.valueOf('S'), "slabWood",
                    Character.valueOf('L'), "plankWood", Character.valueOf('H'), "chestWood" }));

        GameRegistry.addRecipe(
            new ItemStack(slipstreamGenerator),
            new Object[] { "WWW", "FAF", "WWW", Character.valueOf('W'), witchwoodLog, Character.valueOf('F'),
                Items.feather, Character.valueOf('A'),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "IDI", "DBD", "IDI", Character.valueOf('I'), "ingotIron", Character.valueOf('D'),
                    "dustVinteum", Character.valueOf('B'), new ItemStack(AMOres, 1, AMOres.META_CHIMERITE_BLOCK) }));

        // Import Gem
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(crystalMarker, 1, BlockCrystalMarker.META_IN),
                new Object[] { " G ", "GDG", " G ", Character.valueOf('G'), "gemBlueTopaz", Character.valueOf('D'),
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "GDG", "DED", "GDG", Character.valueOf('G'), "gemBlueTopaz", Character.valueOf('D'),
                    "dyeGreen", // Cactus Green
        ...
        GameRegistry.addRecipe(
            ...
            new Object[] { "ACA", "OPO", "OOO", Character.valueOf('A'), BlocksCommonProxy.craftingAltar,
                Character.valueOf('C'), new ItemStack(Blocks.carpet, 1, Short.MAX_VALUE), Character.valueOf('O'),
                Blocks.obsidian, Character.valueOf('P'), Blocks.enchanting_table });
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                ...
                new Object[] { "VDV", "WFW", "VDV", 'W', new ItemStack(BlocksCommonProxy.magicWall), 'V', "dustVinteum",
                    'D', new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_COSMICDUST), 'F',
                    new ItemStack(ItemsCommonProxy.flickerJar, 1, Affinity.ARCANE.ordinal()) }));

        // Entropic Enervator
        GameRegistry.addRecipe(
            new ItemStack(entropicEnervator),
            new Object[] { "GCG", "ORO", "OOO", Character.valueOf('G'), BlocksCommonProxy.goldInlay,
                Character.valueOf('C'), ItemsCommonProxy.deficitCrystal, Character.valueOf('O'), Blocks.obsidian,
                Character.valueOf('R'), Items.redstone });

        // storage blocks
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, AMOres.META_MOONSTONE_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_MOONSTONE));
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, AMOres.META_VINTEUM_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_VINTEUMDUST));
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, AMOres.META_BLUE_TOPAZ_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_BLUETOPAZ));
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, AMOres.META_SUNSTONE_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SUNSTONE));
        createStorageBlockRecipe(
            new ItemStack(AMOres, 1, AMOres.META_CHIMERITE_BLOCK),
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_CHIMERITE));

        // furnace recipes
        GameRegistry.addSmelting(
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_ARCANECOMPOUND),
            new ItemStack(ItemsCommonProxy.itemOre, 2, ItemsCommonProxy.itemOre.META_ARCANEASH),
            0);

        addMetaSmeltingRecipe(
            AMOres,
            AMOres.META_VINTEUM_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_VINTEUMDUST));

        addMetaSmeltingRecipe(
            AMOres,
            AMOres.META_SUNSTONE_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_SUNSTONE));
        addMetaSmeltingRecipe(
            AMOres,
            AMOres.META_BLUE_TOPAZ_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_BLUETOPAZ));
        addMetaSmeltingRecipe(
            AMOres,
            AMOres.META_CHIMERITE_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_CHIMERITE));
        addMetaSmeltingRecipe(
            AMOres,
            AMOres.META_MOONSTONE_ORE,
            new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_MOONSTONE));
    ...
    public void RegisterBlocks() {
        ...
        registerMultiTextureBlock(
            crystalMarker,
            "crystalMarker",
            new ItemMultiTexture(crystalMarker, crystalMarker, crystalMarker.crystalMarkerTypes)
