...
public class IllusionBlock extends AMBlock {
    ...
    public float getBlockHardness(World world, int x, int y, int z) {
        ...
        if (mimicLocation != null) {
            ...
            if (mimicBlock != null && mimicBlock != Blocks.air) {
                return mimicBlock
                    .getBlockHardness(world, (int) mimicLocation.x, (int) mimicLocation.y, (int) mimicLocation.z);
            }
        }
    ...
    public float getExplosionResistance(Entity par1Entity, World world, int x, int y, int z, double explosionX,
        ...
        if (mimicLocation != null) {
            Block mimicBlock = getMimicBlock(world, mimicLocation);
            if (mimicBlock != null && mimicBlock != Blocks.air) {
                return mimicBlock.getExplosionResistance(
                    par1Entity,
                    world,
                    (int) mimicLocation.x,
                    (int) mimicLocation.y,
    ...
    public IIcon getIcon(IBlockAccess blockAccess, int x, int y, int z, int face) {
        if (Minecraft.getMinecraft().thePlayer.isPotionActive(BuffList.trueSight.id)
            && !alwaysPassable(blockAccess, x, y, z)) {
            return revealedIcon;
        }
        ...
        if (mimicLocation == null) {
            ...
            if (mimicBlock != null && mimicBlock != Blocks.air) {
                return mimicBlock
                    .getIcon(blockAccess, (int) mimicLocation.x, (int) mimicLocation.y, (int) mimicLocation.z, face);
            }
        }
        return revealedIcon;
    }
    ...
    public Object[] GetRecipeComponents(boolean alwaysPassable) {
        if (alwaysPassable) {
            return new Object[] { "BRB", "RGR", "BRB", Character.valueOf('R'),
                new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_BLACK), Character.valueOf('G'),
                Blocks.glass, Character.valueOf('B'),
            ...
            return new Object[] { "BRB", "R R", "BRB", Character.valueOf('R'),
                new ItemStack(ItemsCommonProxy.rune, 1, ItemsCommonProxy.rune.META_BLACK), Character.valueOf('B'),
                new ItemStack(ItemsCommonProxy.itemOre, 1, ItemsCommonProxy.itemOre.META_CHIMERITE) };
        }
    }
    ...
    public void addCollisionBoxesToList(World par1World, int par2, int par3, int par4, AxisAlignedBB par5AxisAlignedBB,
        ...
        if (alwaysPassable(par1World, par2, par3, par4)) return;

        if (par7Entity instanceof EntityLivingBase
            && ((EntityLivingBase) par7Entity).isPotionActive(BuffList.trueSight.id)) {
            return;
        }
    ...
    public int colorMultiplier(IBlockAccess blockAccess, int x, int y, int z) {
        ...
        if (mimicLocation != null) {
            ...
            if (mimicBlock != null && mimicBlock != Blocks.air) {
                return mimicBlock
                    .colorMultiplier(blockAccess, (int) mimicLocation.x, (int) mimicLocation.y, (int) mimicLocation.z);
            }
        }
    ...
    /**
     * Can't be normal since entities can pass through it - if it is normal then the "inside block" ui overlay happens
     * and is annoying
     */
    @Override
    ...
    public int getLightOpacity(IBlockAccess world, int x, int y, int z) {
        ...
        if (mimicLocation != null) {
            ...
            if (mimicBlock != null && mimicBlock != Blocks.air) {
                return mimicBlock
                    .getLightOpacity(world, (int) mimicLocation.x, (int) mimicLocation.y, (int) mimicLocation.z);
            }
        }
    ...
    public int getLightValue(IBlockAccess world, int x, int y, int z) {
        ...
        if (mimicLocation != null) {
            ...
            if (mimicBlock != null && mimicBlock != Blocks.air) {
                return mimicBlock
                    .getLightValue(world, (int) mimicLocation.x, (int) mimicLocation.y, (int) mimicLocation.z);
            }
        }
