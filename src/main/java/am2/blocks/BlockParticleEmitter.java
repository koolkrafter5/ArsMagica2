...
public class BlockParticleEmitter extends AMBlockContainer {
    ...
    public boolean removedByPlayer(World world, EntityPlayer player, int x, int y, int z) {
        ...
        if (tile != null && !tile.getShow()) return false;
    ...
    public void onBlockExploded(World world, int x, int y, int z, Explosion explosion) {
        ...
        if (te instanceof TileEntityParticleEmitter) te2 = (TileEntityParticleEmitter) te;
        if (te2 == null) super.onBlockExploded(world, x, y, z, explosion);
        if (te2 != null && te2.getShow()) super.onBlockExploded(world, x, y, z, explosion);
