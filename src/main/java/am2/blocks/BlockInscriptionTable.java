...
public class BlockInscriptionTable extends AMSpecialRenderBlockContainer {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
        ...
        FMLNetworkHandler.openGui(
            par5EntityPlayer,
            AMCore.instance,
            ArsMagicaGuiIdList.GUI_INSCRIPTION_TABLE,
            par1World,
            par2,
            par3,
            par4);
    ...
    public void breakBlock(World world, int i, int j, int k, Block par5, int metadata) {
        ...
        if (world.getBlock(x, j, z) == this) world.setBlock(x, j, z, Blocks.air);
        ...
        if (!world.isRemote && main) {
            ...
            for (int m = 0; m < stat; ++m) spawnItemOnBreak(
                world,
                i,
                j,
                k,
                par5,
                metadata,
                new ItemStack(ItemsCommonProxy.inscriptionUpgrade, 1, m));
        }
