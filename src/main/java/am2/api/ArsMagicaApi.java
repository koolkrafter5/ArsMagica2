...
public class ArsMagicaApi {
    ...
    public static final IAttribute maxBurnoutBonus = new RangedAttribute(
        ...
        0.0f,
        0.0f,
        Double.MAX_VALUE).setDescription("Burnout Bonus")
            .setShouldWatch(true);
    ...
    public static final IAttribute xpGainModifier = new RangedAttribute(
        ...
        1.0f,
        0.0f,
        Double.MAX_VALUE).setDescription("XP Mutiplier")
            .setShouldWatch(true);
    ...
    public static final IAttribute manaRegenTimeModifier = new RangedAttribute(
        ...
        1.0f,
        0.5f,
        2.0f).setDescription("Mana Regen Rate Multiplier")
            .setShouldWatch(true);
    ...
    public final void setBuffHelper(IBuffHelper helper) {
        if (this.buffHelper == null) this.buffHelper = helper;
    }
