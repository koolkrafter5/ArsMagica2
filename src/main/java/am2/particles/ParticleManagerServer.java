...
public class ParticleManagerServer {
    ...
    public Object spawn(World world, String name, double x, double y, double z, double targetX, double targetY,
        ...
        if (!world.isRemote) {
            ...
            AMNetHandler.INSTANCE.sendPacketToAllClientsNear(
                ...
                z,
                32,
                AMPacketIDs.PARTICLE_SPAWN_SPECIAL,
                writer.generate());
        }
        return null;
    }
    ...
    public ParticleController createDefaultParticleController(int type, Object effect, AMVector3 location,
        float modifier, int meta) {
        return null;
    }
}
