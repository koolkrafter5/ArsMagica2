...
public class AMRibbon extends EntityFX {
    ...
    @Override
    public void renderParticle(Tessellator par1Tessellator, float partialframe, float cosyaw, float cospitch,
    ...
    void addRibbonCurve() {
        ...
        AMVector3 lastMidPt = new AMVector3(
            (curPt.x + lastPt.x) / 2,
            (curPt.y + lastPt.y) / 2,
            (curPt.z + lastPt.z) / 2);
