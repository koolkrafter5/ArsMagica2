...
public class ParticleLeaveParticleTrail extends ParticleController {
    ...
    public void doUpdate() {
        ...
        if (updateTicks == ticksBetweenSpawns) {
            ...
            if (effect != null) {
                ...
                if (this.childAffectedByGravity) effect.setAffectedByGravity();
    ...
    public ParticleController clone() {
        ParticleLeaveParticleTrail clone = new ParticleLeaveParticleTrail(
            particle,
            particleName,
            ignoreMaxAge,
            maxAge,
            priority,
            exclusive).setParticleRGB_F(r, g, b)
        ...
        if (this.childAffectedByGravity) clone.setChildAffectedByGravity();
