...
public class AMBeam extends EntityFX implements IBeamParticle {
    ...
    private static final ResourceLocation beam1 = new ResourceLocation(
        "arsmagica2",
        ResourceManager.GetFXTexturePath("beam.png"));
    private static final ResourceLocation beam2 = new ResourceLocation(
        "arsmagica2",
        ResourceManager.GetFXTexturePath("beam1.png"));
    private static final ResourceLocation beam3 = new ResourceLocation(
        "arsmagica2",
        ResourceManager.GetFXTexturePath("beam2.png"));
