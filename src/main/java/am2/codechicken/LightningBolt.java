...
public class LightningBolt extends EntityFX {
    ...
    private static final ResourceLocation bolt = new ResourceLocation(
        "arsmagica2",
        ResourceManager.GetFXTexturePath("smoke.png"));
    ...
    private void renderBolt(Tessellator tessellator, float partialframe, float cosyaw, float cospitch, float sinyaw,
        ...
        int renderlength = (int) ((this.main.particleAge + partialframe + (int) (this.main.length * 3.0F))
            / (int) (this.main.length * 3.0F)
            * this.main.numsegments0);
