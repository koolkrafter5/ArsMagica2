...
public class AM2WorldDecorator implements IWorldGenerator {
    ...
    public AM2WorldDecorator() {
        ...
        vinteum = new WorldGenMinable(
            ...
            BlocksCommonProxy.AMOres.META_VINTEUM_ORE,
            vinteumVein,
            Blocks.stone);
        chimerite = new WorldGenMinable(
            BlocksCommonProxy.AMOres,
            BlocksCommonProxy.AMOres.META_CHIMERITE_ORE,
            chimeriteVein,
            Blocks.stone);
        blueTopaz = new WorldGenMinable(
            BlocksCommonProxy.AMOres,
            BlocksCommonProxy.AMOres.META_BLUE_TOPAZ_ORE,
            topazVein,
            Blocks.stone);
        sunstone = new WorldGenMinable(
            BlocksCommonProxy.AMOres,
            BlocksCommonProxy.AMOres.META_SUNSTONE_ORE,
            sunstoneVein,
            Blocks.lava);
